...
10. preserve M0 semantic invariants while increasing execution realism
...
2. preserve locked wire decisions and M1-S3/M1-S4/M1-S5/M1-S6/M1-S7/M1-S8/M1-S9 deterministic error-ID behavior
3. keep S1..S5 + M1-S1 + M1-S2 + M1-S3 + M1-S4 + M1-S5 + M1-S6 + M1-S7 + M1-S8 + M1-S9 regression suite green on each implementation pass

---

## 5. Done/Doing/Next Snapshot

1. `Done`: M0 exit review, M1 entry plan, M1-S1 closure, M1-S2 closure, M1-S3 closure, M1-S4 closure, M1-S5 closure, M1-S6 closure, M1-S7 closure, M1-S8 closure, M1-S9 closure.
2. `Doing`: next bounded M1 slice selection and sequencing from M1-S9 closure baseline.
