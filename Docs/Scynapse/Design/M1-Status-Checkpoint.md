...
9. preserve M0 semantic invariants while increasing execution realism
...
2. preserve locked wire decisions and M1-S3/M1-S4/M1-S5/M1-S6/M1-S7/M1-S8 deterministic error-ID behavior
3. keep S1..S5 + M1-S1 + M1-S2 + M1-S3 + M1-S4 + M1-S5 + M1-S6 + M1-S7 + M1-S8 regression suite green on each implementation pass
