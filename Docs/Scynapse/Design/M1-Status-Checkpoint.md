...
6. preserve M0 semantic invariants while increasing execution realism
...
2. preserve locked wire decisions and M1-S3/M1-S4/M1-S5 deterministic error-ID behavior
3. keep S1..S5 + M1-S1 + M1-S2 + M1-S3 + M1-S4 + M1-S5 regression suite green on each implementation pass

---

## 5. Done/Doing/Next Snapshot

1. `Done`: M0 exit review, M1 entry plan, M1-S1 closure, M1-S2 closure, M1-S3 closure, M1-S4 closure, M1-S5 closure.
2. `Doing`: final continuity synchronization and scoped commit/push preparation for M1-S5 closure.
