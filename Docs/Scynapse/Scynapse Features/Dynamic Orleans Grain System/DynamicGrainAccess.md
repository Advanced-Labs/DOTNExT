...
### Integration with Plugin Loading (Scynapse.md)

This Dynamic Grain Access system complements the MDCP-based plugin loading system documented in `Scynapse.md`:

| System | Purpose | Key Features |
|--------|---------|--------------|
| **Plugin Loading** (Scynapse.md) | Runtime assembly loading/unloading | `IPluginGrainLoader`, `IPluginGrainUnloader`, MDCP isolation, manifest propagation |
