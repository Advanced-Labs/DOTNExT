...
**Location:** `/src/Scynapse/src/Orleans.Core.Abstractions/State/StateAttribute.cs`
...
**Location:** `/src/Scynapse/src/Orleans.Core.Abstractions/State/NotStateAttribute.cs`

Excludes public properties from state code generation (for dependencies, loggers, etc.)

#### 1.4 LibraryTypes Extension

**Location:** `/src/Scynapse/src/Orleans.CodeGenerator/LibraryTypes.cs`
...
**Location:** `/src/Scynapse/src/Orleans.CodeGenerator/StatePropertyCodeGenerator.cs`
...
**Location:** `/src/Scynapse/src/Orleans.CodeGenerator/CodeGenerator.cs`
...
**Location:** `/src/Scynapse/src/Orleans.CodeGenerator/ProxyGenerator.cs`
...
| Component | Path |
|-----------|------|
| StateTask<T> | `/src/Scynapse/src/Orleans.Core.Abstractions/State/StateTask.cs` |
| StateAttribute | `/src/Scynapse/src/Orleans.Core.Abstractions/State/StateAttribute.cs` |
| NotStateAttribute | `/src/Scynapse/src/Orleans.Core.Abstractions/State/NotStateAttribute.cs` |
| StatePropertyCodeGenerator | `/src/Scynapse/src/Orleans.CodeGenerator/StatePropertyCodeGenerator.cs` |
| LibraryTypes | `/src/Scynapse/src/Orleans.CodeGenerator/LibraryTypes.cs` |
| CodeGenerator | `/src/Scynapse/src/Orleans.CodeGenerator/CodeGenerator.cs` |
| ProxyGenerator | `/src/Scynapse/src/Orleans.CodeGenerator/ProxyGenerator.cs` |
...
The full design specification is in `/Docs/Scynapse/Scynapse Features/` (original task description).
