...
Scynapse Events v1 enables developers to declare standard C# events on grain classes and have them work transparently across the distributed Orleans system.
...
An event triggers Scynapse Event codegen if ALL of:
...
```csharp
// <auto-generated />
// Scynapse Events v1 - Generated event interface members
#nullable enable
...
```csharp
// <auto-generated />
// Scynapse Events v1 - Generated grain event infrastructure
#nullable enable
    ...
    public partial class PlayerGrain : global::Orleans.ILifecycleParticipant<global::Orleans.IGrainLifecycle>
    {
            ...
            global::Orleans.IGrainLifecycle lifecycle)
        {
            lifecycle.Subscribe<PlayerGrain>(
                ...
                ct => { __InitializeScynapseEvents(); return global::System.Threading.Tasks.Task.CompletedTask; },
                ct => { __CleanupScynapseEvents(); return global::System.Threading.Tasks.Task.CompletedTask; }
            );
        }
        ...
        private void __InitializeScynapseEvents()
        {
        ...
        private void __CleanupScynapseEvents()
        {
            ...
            T payload)
        {
            ...
            catch (global::System.Exception ex)
            {
                ...
                this.GetLogger().LogWarning(
                    ex, 
                    "Scynapse Event: Failed to publish to stream. " +
            ...
            global::MyGame.Grains.IPlayerGrain.SubscribeToChatMessageAsync()
        {
            if (__chatMessage_stream == null)
            {
                throw new global::System.InvalidOperationException(
                    "Scynapse Event infrastructure not initialized.");
            }
...
```csharp
// <auto-generated />
// Scynapse Events v1 - Generated proxy event implementation
#nullable enable
...
- [ ] Sample application demonstrating Scynapse Events v1
...
public partial class PlayerGrain : Grain, IPlayerGrain
{
    // This will get Scynapse Event codegen
    public event EventHandler<string>? ChatMessage;
...
Scynapse Events v1 requires SMS (Simple Message Streams) to be configured:
