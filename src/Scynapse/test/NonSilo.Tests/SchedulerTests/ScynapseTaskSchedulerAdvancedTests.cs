...
{
    /// <summary>
    /// Advanced tests for Scynapse task scheduler functionality.
    /// </summary>
    public class ScynapseTaskSchedulerAdvancedTests : IDisposable
    {
        ...
        public ScynapseTaskSchedulerAdvancedTests(ITestOutputHelper output)
        {
            this.output = output;
            this.loggerFactory = ScynapseTaskSchedulerBasicTests.InitSchedulerLogging();
        }
...
#pragma warning restore xUnit1031 // Do not use blocking task operations in test method
        ...
        [Fact, TestCategory("Functional"), TestCategory("Scheduler")]
        public async Task Sched_AC_ContinueWith_2_ScynapseSched()
        {
            var context = UnitTestSchedulingContext.Create(loggerFactory);
