...
{
    /// <summary>
    /// Second set of advanced tests for Scynapse task scheduler.
    /// </summary>
    public class ScynapseTaskSchedulerAdvancedTests_Set2 : IDisposable
    {
        ...
        public ScynapseTaskSchedulerAdvancedTests_Set2(ITestOutputHelper output)
        {
            this.output = output;
