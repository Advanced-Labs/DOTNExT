...
{
    /// <summary>
    /// Tests for Redis grain storage using Scynapse serializer.
    /// </summary>
    [TestCategory("Redis"), TestCategory("Persistence"), TestCategory("Functional")]
    [Collection(TestEnvironmentFixture.DefaultCollection)]
    public class RedisStorageTests_ScynapseSerializer
    {
        private readonly CommonFixture fixture;
        private readonly CommonStorageTests commonStorageTests;

        public RedisStorageTests_ScynapseSerializer(ITestOutputHelper output, CommonFixture commonFixture)
        {
