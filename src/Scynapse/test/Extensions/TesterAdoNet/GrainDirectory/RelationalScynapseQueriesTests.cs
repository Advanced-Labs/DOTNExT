...
using Scynapse.GrainDirectory.AdoNet.Storage;
...
{
    public PostgreSqlRelationalScynapseQueriesTests() : base(AdoNetInvariants.InvariantNamePostgreSql, 90)
    {
...
{
    public MySqlRelationalScynapseQueriesTests() : base(AdoNetInvariants.InvariantNameMySql, 90)
    {
...
public abstract class RelationalScynapseQueriesTests(string invariant, int concurrency = 100) : IAsyncLifetime
{
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_RegistersActivation()
    {
        // arrange
        ...
        var results = await _storage.ReadAsync<AdoNetGrainDirectoryEntry>("SELECT * FROM ScynapseGrainDirectory");
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_UnregistersActivation()
    {
        // arrange
        var clusterId = RandomClusterId();
        var providerId = RandomProviderId();
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_LooksUpActivation()
    {
        // arrange
        var clusterId = RandomClusterId();
        var providerId = RandomProviderId();
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_UnregistersActivationsForSilos()
    {
        // arrange
        var clusterId = RandomClusterId();
        var providerId = RandomProviderId();
