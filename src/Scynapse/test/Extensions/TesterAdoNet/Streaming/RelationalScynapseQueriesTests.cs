...
/// <summary>
/// Tests the relational storage layer via <see cref="RelationalScynapseQueries"/> against Sql Server.
/// </summary>
public class SqlServerRelationalScynapseQueriesTests() : RelationalScynapseQueriesTests(AdoNetInvariants.InvariantNameSqlServer, 90)
{
}

/// <summary>
/// Tests the relational storage layer via <see cref="RelationalScynapseQueries"/> against MySQL.
/// </summary>
public class MySqlRelationalScynapseQueriesTests : RelationalScynapseQueriesTests
{
    public MySqlRelationalScynapseQueriesTests() : base(AdoNetInvariants.InvariantNameMySql, 100)
    {
...
/// <summary>
/// Tests the relational storage layer via <see cref="RelationalScynapseQueries"/> against PostgreSQL.
/// </summary>
public class PostgreSqlRelationalScynapseQueriesTests : RelationalScynapseQueriesTests
{
    public PostgreSqlRelationalScynapseQueriesTests() : base(AdoNetInvariants.InvariantNamePostgreSql, 99)
    {
...
/// <summary>
/// Tests the relational storage layer via <see cref="RelationalScynapseQueries"/>.
/// </summary>
[TestCategory("AdoNet"), TestCategory("Streaming")]
public abstract class RelationalScynapseQueriesTests(string invariant, int concurrency = 100) : IAsyncLifetime
{
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_QueuesMessage()
    {
        // arrange
        ...
        // assert - storage
        var messages = await _storage.ReadAsync<AdoNetStreamMessage>("SELECT * FROM ScynapseStreamMessage");
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_QueuesManyMessagesInParallel()
    {
        // arrange
        var serviceId = RandomServiceId();
        var providerId = RandomProviderId();
        ...
        var stored = (await _storage.ReadAsync<AdoNetStreamMessage>("SELECT * FROM ScynapseStreamMessage"))
            .OrderBy(x => x.ServiceId)
            .ThenBy(x => x.ProviderId)
            .ThenBy(x => x.QueueId)
            .ThenBy(x => x.MessageId)
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_QueuesManyMessagesInParallelOnManyQueues()
    {
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_DequeuesSingleMessage()
    {
        // arrange
        await _storage.ExecuteAsync("DELETE FROM ScynapseStreamMessage");
        var serviceId = RandomServiceId();
        var providerId = RandomProviderId();
        var queueId = RandomQueueId();
        var payload = RandomPayload();
        ...
        var stored = Assert.Single(await _storage.ReadAsync<AdoNetStreamMessage>("SELECT * FROM ScynapseStreamMessage"));
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_DequeuesMessageBatches()
    {
        // arrange
        var serviceId = RandomServiceId();
        var providerId = RandomProviderId();
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_DequeuesSingleMessageAgainAfterVisibilityTimeout()
    {
        // arrange
        var serviceId = RandomServiceId();
        var providerId = RandomProviderId();
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_DoesNotDequeueSingleMessageBeforeVisibilityTimeout()
    {
        // arrange
        var serviceId = RandomServiceId();
        var providerId = RandomProviderId();
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_DoesNotDequeueSingleMessageAfterExpiry()
    {
        // arrange
        var serviceId = RandomServiceId();
        var providerId = RandomProviderId();
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_ConfirmsMessages()
    {
        // arrange
        var serviceId = RandomServiceId();
        var providerId = RandomProviderId();
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_DoesNotConfirmMessagesWithWrongReceipt()
    {
        // arrange
        var serviceId = RandomServiceId();
        var providerId = RandomProviderId();
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_ConfirmsSomeMessagesAndNotOthers()
    {
        // arrange
        var serviceId = RandomServiceId();
        var providerId = RandomProviderId();
    ...
    /// </remarks>
    [SkippableFact]
    public async Task RelationalScynapseQueries_ChaosTest()
    {
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_MovesPoisonedMessageToDeadLetters()
    {
        // arrange
        ...
        Assert.Empty(await _storage.ReadAsync<AdoNetStreamMessage>("SELECT * FROM ScynapseStreamMessage"));
    ...
    /// </summary>
    [SkippableFact]
    public async Task RelationalScynapseQueries_DoesNotMoveHealthyMessageToDeadLetters()
    {
        // arrange
        var serviceId = "ServiceId";
        var providerId = "ProviderId";
        ...
        var saved = Assert.Single(await _storage.ReadAsync<AdoNetStreamMessage>("SELECT * FROM ScynapseStreamMessage"));
