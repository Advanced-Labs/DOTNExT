...
/// <summary>
/// Integration tests for DurableGrain functionality in Scynapse.
/// 
/// DurableGrain is a base class that provides automatic state persistence using Scynapse' journaling
...
public class DurableGrainTests(IntegrationTestFixture fixture) : IClassFixture<IntegrationTestFixture>
{
    ...
    /// Verifies that Scynapse' serialization correctly handles nested objects
