...
namespace Scynapse.Journaling.Tests;

/// <summary>
/// Tests for DurableDictionary, a persistent dictionary implementation that uses Scynapse' journaling
/// infrastructure to maintain state across grain activations and system restarts.
/// 
/// DurableDictionary is part of Scynapse' event sourcing capabilities, providing a dictionary
...
/// Scynapse can serialize this type for journaling.
/// </summary>
[GenerateSerializer]
