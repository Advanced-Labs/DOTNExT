...
namespace Scynapse.Connections.Security.Tests
{
    /// <summary>
    /// Tests for TLS (Transport Layer Security) support in Scynapse connections.
    /// 
    /// Scynapse supports TLS encryption for:
    ...
    /// - Securing Scynapse deployments in untrusted networks
    ...
    public class TlsConnectionTests
    {
        ...
        /// <summary>
        /// Configures TLS for Scynapse clients in the test cluster.
        /// Sets up:
        ...
        /// <summary>
        /// Configures TLS for Scynapse silos in the test cluster.
        /// Sets up:
