...
namespace ScynapseCodeGen.TestProject
{
    ...
    public sealed class Codec_DemoData : global::Scynapse.Serialization.Codecs.IFieldCodec<global::TestProject.DemoData>, global::Scynapse.Serialization.Serializers.IBaseCodec<global::TestProject.DemoData>
    {
        ...
        private readonly global::Scynapse.Serialization.Codecs.ArrayCodec<int> _codec0;
        public Codec_DemoData(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider)
        {
            _codec0 = ScynapseGeneratedCodeHelper.GetService<global::Scynapse.Serialization.Codecs.ArrayCodec<int>>(this, codecProvider);
        }
        ...
        {
            global::Scynapse.Serialization.Codecs.Int32Codec.WriteField(ref writer, 0U, instance.IntProp);
            global::Scynapse.Serialization.Codecs.DoubleCodec.WriteField(ref writer, 1U, instance.DoubleProp);
            global::Scynapse.Serialization.Codecs.FloatCodec.WriteField(ref writer, 1U, instance.FloatProp);
            global::Scynapse.Serialization.Codecs.Int64Codec.WriteField(ref writer, 1U, instance.LongProp);
            global::Scynapse.Serialization.Codecs.BoolCodec.WriteField(ref writer, 1U, instance.BoolProp);
            global::Scynapse.Serialization.Codecs.ByteCodec.WriteField(ref writer, 1U, instance.ByteProp);
            global::Scynapse.Serialization.Codecs.Int16Codec.WriteField(ref writer, 1U, instance.ShortProp);
            global::Scynapse.Serialization.Codecs.CharCodec.WriteField(ref writer, 1U, instance.CharProp);
            global::Scynapse.Serialization.Codecs.UInt32Codec.WriteField(ref writer, 1U, instance.UIntProp);
            global::Scynapse.Serialization.Codecs.UInt64Codec.WriteField(ref writer, 1U, instance.ULongProp);
            global::Scynapse.Serialization.Codecs.UInt16Codec.WriteField(ref writer, 1U, instance.UShortProp);
            global::Scynapse.Serialization.Codecs.SByteCodec.WriteField(ref writer, 1U, instance.SByteProp);
            global::Scynapse.Serialization.Codecs.DecimalCodec.WriteField(ref writer, 1U, instance.DecimalProp);
            global::Scynapse.Serialization.Codecs.DateTimeCodec.WriteField(ref writer, 1U, instance.DateTimeProp);
            global::Scynapse.Serialization.Codecs.DateTimeOffsetCodec.WriteField(ref writer, 1U, instance.DateTimeOffsetProp);
            global::Scynapse.Serialization.Codecs.TimeSpanCodec.WriteField(ref writer, 1U, instance.TimeSpanProp);
            global::Scynapse.Serialization.Codecs.GuidCodec.WriteField(ref writer, 1U, instance.GuidProp);
        ...
        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::TestProject.DemoData instance)
        {
            ...
            while (true)
            {
                ...
                if (id == 0U)
                {
                    instance.IntProp = global::Scynapse.Serialization.Codecs.Int32Codec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 1U)
                {
                    instance.DoubleProp = global::Scynapse.Serialization.Codecs.DoubleCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 2U)
                {
                    instance.FloatProp = global::Scynapse.Serialization.Codecs.FloatCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 3U)
                {
                    instance.LongProp = global::Scynapse.Serialization.Codecs.Int64Codec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 4U)
                {
                    instance.BoolProp = global::Scynapse.Serialization.Codecs.BoolCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 5U)
                {
                    instance.ByteProp = global::Scynapse.Serialization.Codecs.ByteCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 6U)
                {
                    instance.ShortProp = global::Scynapse.Serialization.Codecs.Int16Codec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 7U)
                {
                    instance.CharProp = global::Scynapse.Serialization.Codecs.CharCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 8U)
                {
                    instance.UIntProp = global::Scynapse.Serialization.Codecs.UInt32Codec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 9U)
                {
                    instance.ULongProp = global::Scynapse.Serialization.Codecs.UInt64Codec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 10U)
                {
                    instance.UShortProp = global::Scynapse.Serialization.Codecs.UInt16Codec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 11U)
                {
                    instance.SByteProp = global::Scynapse.Serialization.Codecs.SByteCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 12U)
                {
                    instance.DecimalProp = global::Scynapse.Serialization.Codecs.DecimalCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 13U)
                {
                    instance.DateTimeProp = global::Scynapse.Serialization.Codecs.DateTimeCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 14U)
                {
                    instance.DateTimeOffsetProp = global::Scynapse.Serialization.Codecs.DateTimeOffsetCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 15U)
                {
                    instance.TimeSpanProp = global::Scynapse.Serialization.Codecs.TimeSpanCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
                ...
                if (id == 16U)
                {
                    instance.GuidProp = global::Scynapse.Serialization.Codecs.GuidCodec.ReadValue(ref reader, header);
                    reader.ReadFieldHeader(ref header);
                    if (header.IsEndBaseOrEndObject)
                        break;
                    id += header.FieldIdDelta;
    ...
    {
        private readonly global::Scynapse.Serialization.Codecs.ArrayCopier<int> _copier0;
        [global::System.Runtime.CompilerServices.MethodImplAttribute(global::System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        ...
        public Copier_DemoData(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider)
        {
            _copier0 = ScynapseGeneratedCodeHelper.GetService<global::Scynapse.Serialization.Codecs.ArrayCopier<int>>(this, codecProvider);
        }
    ...
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("ScynapseCodeGen", "9.0.0.0"), global::System.ComponentModel.EditorBrowsableAttribute(global::System.ComponentModel.EditorBrowsableState.Never), global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverageAttribute]
    internal sealed class Activator_DemoData : global::Scynapse.Serialization.Activators.IActivator<global::TestProject.DemoData>
    {
    ...
    internal sealed class Metadata_TestProject : global::Scynapse.Serialization.Configuration.TypeManifestProviderBase
    {
        protected override void ConfigureInner(global::Scynapse.Serialization.Configuration.TypeManifestOptions config)
        {
            ...
            config.Activators.Add(typeof(ScynapseCodeGen.TestProject.Activator_DemoData));
        }
    }
}
