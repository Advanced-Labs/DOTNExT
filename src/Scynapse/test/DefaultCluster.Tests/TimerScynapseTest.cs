...
{
    /// <summary>
    /// Tests for Scynapse Timer functionality.
    ...
    /// </summary>
    public class TimerScynapseTest : HostedTestClusterEnsureDefaultStarted
    {
        private readonly ITestOutputHelper output;

        public TimerScynapseTest(ITestOutputHelper output, DefaultClusterFixture fixture)
            : base(fixture)
        {
            this.output = output;
        }
        ...
        public async Task TimerScynapseTest_Basic()
        {
            for (int i = 0; i < 10; i++)
            {
        ...
        public async Task TimerScynapseTest_Parallel()
        {
        ...
        /// </summary>
        [Fact, TestCategory("BVT"), TestCategory("Timers")]
        public async Task TimerScynapseTest_Migration()
        {
            ITimerGrain grain = GrainFactory.GetGrain<ITimerGrain>(GetRandomGrainId());
        ...
        /// </summary>
        [Fact, TestCategory("SlowBVT"), TestCategory("Timers")]
        public async Task TimerScynapseTest_Basic_Poco()
        {
            for (int i = 0; i < 10; i++)
            {
        ...
        /// </summary>
        [Fact, TestCategory("BVT"), TestCategory("Timers")]
        public async Task TimerScynapseTest_Parallel_Poco()
        {
            TimeSpan period = TimeSpan.Zero;
        ...
        /// </summary>
        [Fact, TestCategory("BVT"), TestCategory("Timers")]
        public async Task TimerScynapseTest_Migration_Poco()
        {
            IPocoTimerGrain grain = GrainFactory.GetGrain<IPocoTimerGrain>(GetRandomGrainId());
            TimeSpan period = await grain.GetTimerPeriod();
