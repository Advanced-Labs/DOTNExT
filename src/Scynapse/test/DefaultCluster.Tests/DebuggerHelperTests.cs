...
{
    /// <summary>
    /// Tests debugger helper functionality in Scynapse.
    /// Scynapse provides debugging utilities that allow developers to inspect grain instances
    ...
    public class DebuggerHelperTests : HostedTestClusterEnsureDefaultStarted
    {
        ...
        /// Verifies that the ScynapseDebuggerHelper can retrieve the concrete grain implementation
        ...
        public async Task DebuggerHelper_GetGrainInstance()
        {
            ...
            await grain.ScynapseDebuggerHelper_GetGrainInstance_Test();
        }
    }
}
