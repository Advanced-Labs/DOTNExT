...
[GenerateSerializer]
[SuppressMessage("Usage", "SCYNAPSE0004:Add missing serialization attributes", Justification = "Intentional for tests")]
...
namespace Scynapse.Serialization.UnitTests
{
    ...
    {
        [GenerateSerializer]
        [Alias("Scynapse.Serialization.UnitTests.Outer.InnerNonGen`1")]
        public class InnerNonGen
        {
        }

        [GenerateSerializer]
        [Alias("Scynapse.Serialization.UnitTests.Outer.InnerGen`2")]
