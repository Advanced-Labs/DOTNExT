...
/// <summary>
/// Tests for Scynapse' support of C# record types.
/// 
/// Records are first-class citizens in Scynapse serialization, with full support for:
...
/// 
/// Scynapse handles records efficiently by:
