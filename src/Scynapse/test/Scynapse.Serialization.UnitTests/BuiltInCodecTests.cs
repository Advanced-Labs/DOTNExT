...
namespace Scynapse.Serialization.UnitTests
{
    ...
    /// <summary>
    /// Tests for Scynapse' built-in codecs for primitive and common .NET types.
    /// Scynapse provides optimized serialization codecs for commonly used types including:
    ...
    /// Enums in Scynapse are serialized efficiently as their underlying type values,
