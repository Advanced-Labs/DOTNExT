...
{
    /// <summary>
    /// Tests for Scynapse' type encoding and type manifest system.
    /// 
    /// Scynapse uses an efficient type encoding system that:
    ...
    /// 
    /// The type encoding system is fundamental to Scynapse' ability to:
