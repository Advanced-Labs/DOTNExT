...
{
    /// <summary>
    /// Tests for Scynapse' Newtonsoft.Json serialization support.
    /// 
    /// Scynapse provides integration with Newtonsoft.Json (Json.NET) for scenarios requiring:
    ...
    /// 
    /// The Newtonsoft.Json codec in Scynapse:
    ...
    /// to Scynapse that already have complex Newtonsoft.Json configurations.
    /// </summary>
    [Trait("Category", "BVT")]
