...
{
    /// <summary>
    /// Tests for Scynapse' version tolerance capabilities in serialization.
    /// 
    /// Version tolerance is a critical feature of Scynapse that allows:
    ...
    /// 
    /// Scynapse achieves version tolerance through:
    ...
    {
        private const string TestString = "hello, Scynapse.Serialization";
        ...
        public class SubTypeSerializer : IBaseCodec<SubType>
        {
            ...
            {
                _baseTypeSerializer = ScynapseGeneratedCodeHelper.UnwrapService(this, baseTypeSerializer);
                _stringCodec = ScynapseGeneratedCodeHelper.UnwrapService(this, stringCodec);
                _intCodec = ScynapseGeneratedCodeHelper.UnwrapService(this, intCodec);
                _objectCodec = ScynapseGeneratedCodeHelper.UnwrapService(this, objectCodec);
            }
