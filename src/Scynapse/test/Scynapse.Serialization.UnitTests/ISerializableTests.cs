...
using Scynapse.Serialization.Utilities;
...
{
    /// <summary>
    /// Tests for Scynapse' support of the .NET ISerializable interface.
    /// 
    /// Scynapse provides compatibility with types that implement ISerializable for custom serialization,
    ...
    /// - Providing fallback serialization for types without Scynapse-specific serializers
    /// 
    /// Note: While supported for compatibility, Scynapse' native serialization is preferred
