...
{
    /// <summary>
    /// Tests for Scynapse' low-level Reader and Writer implementations.
    /// 
    /// These tests verify the fundamental building blocks of Scynapse serialization:
    ...
    /// 
    /// These components are critical for Scynapse' wire protocol efficiency
