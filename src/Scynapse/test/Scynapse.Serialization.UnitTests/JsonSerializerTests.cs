...
namespace Scynapse.Serialization.UnitTests
{
    /// <summary>
    /// Tests for Scynapse' JSON serialization support using System.Text.Json.
    ///
    /// Scynapse provides integration with System.Text.Json for scenarios where:
    ...
    ///
    /// The JSON codec in Scynapse:
    /// - Can be selectively applied to specific types using predicates
    /// - Supports polymorphic serialization through Scynapse' type system
    /// - Provides both serialization and deep copy functionality
    /// - Can be combined with Scynapse' native serialization for optimal performance
    /// </summary>
    [Trait("Category", "BVT")]
    public class JsonCodecTests : FieldCodecTester<MyJsonClass?, IFieldCodec<MyJsonClass?>>
    {
        ...
        /// Verifies Scynapse' deep copy functionality with JSON serialization.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests round-trip serialization through Scynapse' codec and serializer systems.
        ...
        /// <summary>
        /// Tests serialization of all JsonNode subtypes through Scynapse.
        ...
        /// <summary>
        /// Tests Scynapse serialization of JsonDocument and JsonElement types.
        /// Verifies these types work correctly with Scynapse' serialization system.
        /// </summary>
        [Fact]
    ...
    /// Focuses on Scynapse' deep copy integration with JSON types.
    /// </summary>
    [Trait("Category", "BVT")]
    public class JsonCodecCopierTests(ITestOutputHelper output) : CopierTester<MyJsonClass?, IDeepCopier<MyJsonClass?>>(output)
    {
        ...
        /// <summary>
        /// Tests deep copying of native JSON types through Scynapse.
