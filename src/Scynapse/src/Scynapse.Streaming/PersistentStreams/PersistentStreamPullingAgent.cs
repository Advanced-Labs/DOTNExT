...
namespace Scynapse.Streams
{
    internal sealed partial class PersistentStreamPullingAgent : SystemTarget, IPersistentStreamPullingAgent
    {
        ...
        public Task Initialize()
        {
            ...
            {
                using var _ = new ExecutionContextSuppressor();
                receiverInitTask = ScynapseTaskExtentions.SafeExecute(() => receiver.Initialize(this.options.InitQueueTimeout))
        ...
        public async Task Shutdown()
        {
            ...
            try
            {
                ...
                {
                    var task = ScynapseTaskExtentions.SafeExecute(() => localReceiver.Shutdown(this.options.InitQueueTimeout));
