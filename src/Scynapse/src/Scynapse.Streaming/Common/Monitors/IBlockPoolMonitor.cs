namespace Scynapse.Providers.Streams.Common
{
    /// <summary>
    ...
    /// These two monitor converge in scynapse cache infrastructure, where ObjectPool is used as block pool to allocate memory, where each object represent a block of memory
