...
{
    internal partial class ScynapseSiloInstanceManager
    {
        ...
        private ScynapseSiloInstanceManager(
            string clusterId,
            ...
            AzureStorageOperationOptions options)
        {
            ...
            logger = loggerFactory.CreateLogger<ScynapseSiloInstanceManager>();
        ...
        public static async Task<ScynapseSiloInstanceManager> GetManager(
            string clusterId,
            ILoggerFactory loggerFactory,
            AzureStorageOperationOptions options)
        {
            var instance = new ScynapseSiloInstanceManager(clusterId, loggerFactory, options);
            try
            {
