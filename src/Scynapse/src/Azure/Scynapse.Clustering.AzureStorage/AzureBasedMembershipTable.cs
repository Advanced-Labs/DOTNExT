...
using Scynapse.Clustering.AzureStorage.Utilities;
...
namespace Scynapse.Runtime.MembershipService
{
    internal partial class AzureBasedMembershipTable : IMembershipTable
    {
        ...
        private ScynapseSiloInstanceManager tableManager;
        ...
        public async Task InitializeMembershipTable(bool tryInitTableVersion)
        {
            ...
            this.tableManager = await ScynapseSiloInstanceManager.GetManager(
                this.clusterId,
                this.loggerFactory,
                this.options);
        ...
        private static MembershipEntry Parse(SiloInstanceTableEntry tableEntry)
        {
            ...
            if (suspectingSilos.Count != suspectingTimes.Count)
                throw new ScynapseException(string.Format("SuspectingSilos.Length of {0} as read from Azure table is not equal to SuspectingTimes.Length of {1}", suspectingSilos.Count, suspectingTimes.Count));
