# Microsoft Scynapse Journaling for Azure Storage

## Introduction
Microsoft Scynapse Journaling for Azure Storage provides an Azure Storage implementation of the Scynapse Journaling provider. This allows logging and tracking of grain operations using Azure Storage as a backing store.

## Getting Started
To use this package, install it via NuGet:

```shell
dotnet add package Genesa.Scynapse.Journaling.AzureStorage
```
...
- [Scynapse Journaling](https://learn.microsoft.com/en-us/dotnet/scynapse/implementation/event-sourcing)
- [Event Sourcing Grains](https://learn.microsoft.com/en-us/dotnet/scynapse/grains/event-sourcing)
