...
using Scynapse.Providers.Azure;
    ...
    public partial class AzureBlobGrainStorage : IGrainStorage, ILifecycleParticipant<ISiloLifecycle>
    {
        ...
        private async Task Init(CancellationToken ct)
        {
            ...
            try
            {
                ...
                {
                    throw new ScynapseConfigurationException($"No credentials specified. Use the {options.GetType().Name}.{nameof(AzureBlobStorageOptions.ConfigureBlobServiceClient)} method to configure the Azure Blob Service client.");
                }
