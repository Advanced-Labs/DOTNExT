# Microsoft Scynapse Durable Jobs for Azure Storage

## Introduction
Microsoft Scynapse Durable Jobs for Azure Storage provides persistent storage for Scynapse Durable Jobs using Azure Blob Storage. This allows your Scynapse applications to schedule jobs that survive silo restarts, grain deactivation, and cluster reconfigurations. Jobs are stored in append blobs, providing efficient storage and retrieval for time-based job scheduling.
...
```shell
dotnet add package Genesa.Scynapse.DurableJobs
dotnet add package Genesa.Scynapse.DurableJobs.AzureStorage
```
...
### Enable Logging
```csharp
builder.Logging.AddFilter("Scynapse.DurableJobs", LogLevel.Information);
builder.Logging.AddFilter("Scynapse.DurableJobs.AzureStorage", LogLevel.Information);
```
...
- [Scynapse Durable Jobs Core Package](../../../Scynapse.DurableJobs/README.md)
