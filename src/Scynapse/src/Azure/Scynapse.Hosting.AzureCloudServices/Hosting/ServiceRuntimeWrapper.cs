...
namespace Scynapse.Runtime.Host
{
    /// <summary>
...
#pragma warning restore 618
                if (assembly == null)
                {
                    ...
                    throw new ScynapseException("Failed to find or load Microsoft.WindowsAzure.ServiceRuntime.");
                }
            }
            ...
            if (string.IsNullOrWhiteSpace(DeploymentId))
                throw new ScynapseException("DeploymentId is null or whitespace.");

            currentRoleInstance = roleEnvironmentType.GetProperty("CurrentRoleInstance").GetValue(null);
            if (currentRoleInstance == null)
                throw new ScynapseException("CurrentRoleInstance is null.");
