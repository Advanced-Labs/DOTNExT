...
namespace Scynapse
{
    ...
    public sealed class GrainCancellationTokenSource : IDisposable
    {
        ...
        /// <summary>
        /// Initializes the <see cref="T:Scynapse.GrainCancellationTokenSource"/>.
        /// </summary>
        ...
        /// <summary>
        /// Releases the resources used by this <see cref="T:Scynapse.Async.GrainCancellationTokenSource" />.
        /// </summary>
        /// <remarks>
