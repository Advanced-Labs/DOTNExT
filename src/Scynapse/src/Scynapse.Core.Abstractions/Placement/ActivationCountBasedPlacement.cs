...
namespace Scynapse.Runtime
{
    ...
    /// but this value is configurable via <c>Scynapse.Runtime.ActivationCountBasedPlacementOptions</c>.
    /// <br/>
    ...
    /// <br/>
    /// This placement strategy is configured by adding the <see cref="Scynapse.Placement.ActivationCountBasedPlacementAttribute"/> attribute to a grain.
    /// </remarks>
