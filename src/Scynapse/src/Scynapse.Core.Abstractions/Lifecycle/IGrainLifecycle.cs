...
namespace Scynapse.Runtime
{
    ...
    public interface IDehydrationContext
    {
        ...
        /// <summary>
        /// Attempts to a value to the dehydration context, associated with the provided key, serializing it using <see cref="Scynapse.Serialization.Serializer"/>.
    ...
    public interface IRehydrationContext
    {
        ...
        /// <summary>
        /// Tries to get a value from the rehydration context, associated with the provided key, deserializing it using <see cref="Scynapse.Serialization.Serializer"/>.
