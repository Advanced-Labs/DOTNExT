...
internal class TransactionClient : ITransactionClient
{
    ...
    private readonly Serializer<ScynapseTransactionAbortedException> _serializer;

    public TransactionClient(ITransactionAgent transactionAgent, Serializer<ScynapseTransactionAbortedException> serializer)
    {
    ...
    private async Task FinalizeTransaction(TransactionInfo transactionInfo)
    {
        ...
        ScynapseTransactionException transactionException;
