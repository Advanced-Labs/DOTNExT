...
namespace Scynapse.Transactions
{
    ...
    {
        private static readonly Meter Meter = new("Scynapse");

        private const string TRANSACTIONS_STARTED = "scynapse-transactions-started";
        private const string TRANSACTIONS_SUCCESSFUL = "scynapse-transactions-successful";
        private const string TRANSACTIONS_FAILED = "scynapse-transactions-failed";
        private const string TRANSACTIONS_THROTTLED = "scynapse-transactions-throttled";
