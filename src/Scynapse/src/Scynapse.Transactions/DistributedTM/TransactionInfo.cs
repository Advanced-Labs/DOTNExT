...
namespace Scynapse.Transactions
{
    ...
    public sealed class TransactionInfo
    {
        ...
        public ScynapseTransactionAbortedException MustAbort(Serializer<ScynapseTransactionAbortedException> serializer)
        {
            ...
            {
                return new ScynapseOrphanCallException(TransactionId.ToString(), PendingCalls);
            }
            else
            {
                return null;
        ...
        public void RecordException(Exception e, Serializer<ScynapseTransactionAbortedException> sm)
        {
            if (OriginalException == null)
            {
                var exception = (e as ScynapseTransactionAbortedException)
                    ?? new ScynapseTransactionAbortedException(TransactionId.ToString(), e);
