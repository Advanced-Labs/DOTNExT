...
namespace Scynapse
{
    ...
    {
        [NonSerialized]
        private Serializer<ScynapseTransactionAbortedException> _serializer;

        [NonSerialized]
        private ITransactionAgent _transactionAgent;

        private ITransactionAgent TransactionAgent => _transactionAgent ?? throw new ScynapseTransactionsDisabledException();
        ...
        protected TransactionRequestBase(Serializer<ScynapseTransactionAbortedException> exceptionSerializer, IServiceProvider serviceProvider)
        {
        ...
        public override async ValueTask<Response> Invoke()
        {
            ...
            if (transactionInfo != null)
            {
                ...
                ScynapseTransactionException transactionException = transactionInfo.MustAbort(_serializer);
        ...
        {
            _serializer = context.ServiceProvider.GetRequiredService<Serializer<ScynapseTransactionAbortedException>>();
    ...
    {
        protected TransactionRequest(Serializer<ScynapseTransactionAbortedException> exceptionSerializer, IServiceProvider serviceProvider) : base(exceptionSerializer, serviceProvider)
        {
        }
    ...
    {
        protected TransactionTaskRequest(Serializer<ScynapseTransactionAbortedException> exceptionSerializer, IServiceProvider serviceProvider) : base(exceptionSerializer, serviceProvider)
        {
        }
