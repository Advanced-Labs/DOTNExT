...
namespace Scynapse.Connections.Security
{
    ...
    public class TlsOptions
    {
        ...
        /// </para>
        /// <para>
        /// To omit client authentication set to <c>null</c> on client and set <see cref="RemoteCertificateMode"/> to <see cref="Scynapse.Connections.Security.RemoteCertificateMode.AllowCertificate"/> or <see cref="Scynapse.Connections.Security.RemoteCertificateMode.NoCertificate"/> on server.
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// Specifies the remote endpoint certificate requirements for a TLS connection. Defaults to <see cref="Scynapse.Connections.Security.RemoteCertificateMode.RequireCertificate"/>.
        /// </summary>
        public RemoteCertificateMode RemoteCertificateMode { get; set; } = RemoteCertificateMode.RequireCertificate;

        /// <summary>
        /// Specifies the client authentication certificate requirements for a TLS connection to Silo. Defaults to <see cref="Scynapse.Connections.Security.RemoteCertificateMode.AllowCertificate"/>.
        /// </summary>
