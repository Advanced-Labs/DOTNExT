...
public sealed class InProcessTestClusterBuilder
{
    ...
    {
        Options.SiloHostConfigurationDelegates.Add((options, hostBuilder) => hostBuilder.UseScynapse(siloBuilder => configureSiloDelegate(options, siloBuilder)));
        return this;
    }
    ...
    {
        Options.ClientHostConfigurationDelegates.Add(hostBuilder => hostBuilder.UseScynapseClient(clientBuilder => configureClientDelegate(clientBuilder)));
        return this;
    }
