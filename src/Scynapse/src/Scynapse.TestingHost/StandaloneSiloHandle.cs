            ...
            Process.OutputDataReceived += (s, e) =>
            {
                ...
                else
                {
                    ...
                    if (!_startedEvent.Task.IsCompleted)
                    {
                        ...
                        {
                            SiloAddress = Scynapse.Runtime.SiloAddress.FromParsableString(e.Data[StandaloneSiloHost.SiloAddressLog.Length..]);
                        }
                        else if (e.Data.StartsWith(StandaloneSiloHost.GatewayAddressLog, StringComparison.Ordinal))
                        {
                            GatewayAddress = Scynapse.Runtime.SiloAddress.FromParsableString(e.Data[StandaloneSiloHost.GatewayAddressLog.Length..]);
                        }
