...
namespace Scynapse.TestingHost
{
    ...
    public class TestClusterBuilder
    {
        ...
        public TestCluster Build()
        {
            ...
            // Since the ClusterId & ServiceId properties are nested under the 'Scynapse' section in the config,
            // we bind the 'Scynapse' section here to bind them to the options.
            configuration.GetSection("Scynapse").Bind(finalOptions);
