...
namespace Scynapse.TestingHost
{
    ...
    public class TestClusterOptions
    {
        ...
        public Dictionary<string, string> ToDictionary()
        {
            ...
            {
                [$"Scynapse:{nameof(ClusterId)}"] = this.ClusterId,
                [$"Scynapse:{nameof(ServiceId)}"] = this.ServiceId,
            ...
            {
                result["Scynapse:Clustering:ProviderType"] = "Development";
            }
    ...
    public class TestSiloSpecificOptions
    {
        ...
        public Dictionary<string, string> ToDictionary()
        {
            var result = new Dictionary<string, string>
            {
                [$"Scynapse:Endpoints:AdvertisedIPAddress"] = IPAddress.Loopback.ToString(),
                [$"Scynapse:Endpoints:{nameof(SiloPort)}"] = this.SiloPort.ToString(),
                [$"Scynapse:EndPoints:{nameof(GatewayPort)}"] = this.GatewayPort.ToString(),
                ["Scynapse:Name"] = this.SiloName,
            };

            if (PrimarySiloEndPoint != null)
            {
                result[$"Scynapse:Clustering:{nameof(PrimarySiloEndPoint)}"] = this.PrimarySiloEndPoint.ToString();
            }
