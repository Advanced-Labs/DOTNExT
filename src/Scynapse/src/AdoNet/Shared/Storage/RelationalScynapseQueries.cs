...
#endif
{
    ...
    /// </summary>
    internal class RelationalScynapseQueries
    {
        /// <summary>
        ...
        /// <summary>
        /// the scynapse functional queries
        /// </summary>
        ...
        /// <param name="dbStoredQueries">Scynapse functional queries</param>
        private RelationalScynapseQueries(IRelationalStorage storage, DbStoredQueries dbStoredQueries)
        {
        ...
        /// <summary>
        /// Creates an instance of a database of type <see cref="RelationalScynapseQueries"/> and Initializes Scynapse queries from the database.
        /// Scynapse uses only these queries and the variables therein, nothing more.
        /// </summary>
        ...
        internal static async Task<RelationalScynapseQueries> CreateInstance(string invariantName, string connectionString)
        {
            ...
            return new RelationalScynapseQueries(storage, new DbStoredQueries(queries.ToDictionary(q => q.Key, q => q.Value)));
        }
        ...
        /// <summary>
        /// Reads Scynapse reminder data from the tables.
        /// </summary>
        ...
        /// <summary>
        /// Lists active gateways. Used mainly by Scynapse clients.
        /// </summary>
        ...
        /// <summary>
        /// Queries Scynapse membership data.
        /// </summary>
