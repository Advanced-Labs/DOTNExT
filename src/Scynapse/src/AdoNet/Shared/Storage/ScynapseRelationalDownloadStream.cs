...
#endif
{
    ...
    /// </summary>
    internal class ScynapseRelationalDownloadStream : Stream
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new <see cref="ScynapseRelationalDownloadStream"/> instance.
        /// </summary>
        ...
        public ScynapseRelationalDownloadStream(DbDataReader reader, int ordinal)
        {
            _reader = reader;
            _ordinal = ordinal;
