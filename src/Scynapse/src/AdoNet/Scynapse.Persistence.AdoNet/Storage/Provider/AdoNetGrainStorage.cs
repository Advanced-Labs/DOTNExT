...
using Scynapse.Configuration.Overrides;
...
namespace Scynapse.Storage
{
    ...
    /// </summary>
    /// <remarks> These are taken from <em>Scynapse.Providers.ProviderErrorCode</em> and <em>Scynapse.Providers.AzureProviderErrorCode</em>.</remarks>
    internal enum RelationalStorageProviderCodes
    {
        //These is from Scynapse.Providers.ProviderErrorCode and Scynapse.Providers.AzureProviderErrorCode.
    ...
    public partial class AdoNetGrainStorage : IGrainStorage, ILifecycleParticipant<ISiloLifecycle>
    {
        ...
        /// <summary>
        /// The default query to initialize this structure from the Scynapse database.
        /// </summary>
        public const string DefaultInitializationQuery = "SELECT QueryKey, QueryText FROM ScynapseQuery WHERE QueryKey = 'WriteToStorageKey' OR QueryKey = 'ReadFromStorageKey' OR QueryKey = 'ClearStorageKey'";
            ...
            string name)
        {
            ...
            this.HashPicker = options.Value.HashPicker ?? new StorageHasherPicker(new[] { new ScynapseDefaultHasher() });
        }
        ...
        /// <remarks>This likely should exist in Scynapse core in more optimized form.</remarks>
