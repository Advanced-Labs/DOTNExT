...
{
    /// <summary>
    /// Scynapse v3-compatible hasher implementation for string-only grain key ids.
    /// </summary>
    internal class Scynapse3CompatibleStringKeyHasher : IHasher
    {
        private readonly Scynapse3CompatibleHasher _innerHasher;
        private readonly string _grainType;

        public Scynapse3CompatibleStringKeyHasher(Scynapse3CompatibleHasher innerHasher, string grainType)
        {
        ...
        {
            // Scynapse v3 treats string-only keys as integer keys with extension (AdoGrainKey.IsLongKey == true),
