...
(
	...
	CONSTRAINT PK_ScynapseStreamMessage PRIMARY KEY
	(
		ServiceId,
        ProviderId,
		QueueId,
...
(
	...
	CONSTRAINT PK_ScynapseStreamDeadLetter PRIMARY KEY
    (
        ServiceId,
        ProviderId,
        QueueId,
...
(
	...
	CONSTRAINT PK_ScynapseStreamControl PRIMARY KEY
    (
        ServiceId,
        ProviderId,
        QueueId
...
DECLARE
	_MessageId BIGINT := nextval('ScynapseStreamMessageSequence');
...
IF _EvictOn IS NULL THEN
    ...
    INSERT INTO ScynapseStreamControl
    (
        ServiceId,
        ProviderId,
        QueueId,
...
UPDATE ScynapseStreamMessage AS M
SET
	Dequeued = Dequeued + 1,
...
DELETE FROM ScynapseStreamMessage AS M
USING Batch AS B
WHERE
    M.ServiceId = B.ServiceId
    AND M.ProviderId = B.ProviderId
...
INSERT INTO ScynapseStreamDeadLetter
(
    ServiceId,
    ProviderId,
    QueueId,
...
DELETE FROM ScynapseStreamDeadLetter AS M
USING Batch AS B
WHERE
    M.ServiceId = B.ServiceId
    AND M.ProviderId = B.ProviderId
