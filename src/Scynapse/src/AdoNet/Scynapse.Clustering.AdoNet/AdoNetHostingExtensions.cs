...
namespace Scynapse.Hosting
{
    ...
    {
        /// <summary>
        /// Configures this silo to use ADO.NET for clustering. Instructions on configuring your database are available at <see href="http://aka.ms/scynapse-sql-scripts"/>.
        /// </summary>
        /// <param name="builder">
        /// The builder.
        /// </param>
        ...
        /// <summary>
        /// Configures this client to use ADO.NET for clustering. Instructions on configuring your database are available at <see href="http://aka.ms/scynapse-sql-scripts"/>.
        /// </summary>
        /// <param name="builder">
        /// The builder.
        /// </param>
