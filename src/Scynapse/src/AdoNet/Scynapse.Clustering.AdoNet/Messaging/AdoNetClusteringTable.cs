...
namespace Scynapse.Runtime.MembershipService
{
    public partial class AdoNetClusteringTable : IMembershipTable
    {
        ...
        public async Task InitializeMembershipTable(bool tryInitTableVersion)
        {
            ...
            //This initializes all of Scynapse operational queries from the database using a well known view
            //and assumes the database with appropriate definitions exists already.
            scynapseQueries = await RelationalScynapseQueries.CreateInstance(
        ...
        public async Task<MembershipTableData> ReadRow(SiloAddress key)
        {
            ...
            try
            {
                return await scynapseQueries.MembershipReadRowAsync(this.clusterId, key);
            }
            catch (Exception ex)
            {
        ...
        public async Task<MembershipTableData> ReadAll()
        {
            ...
            try
            {
                return await scynapseQueries.MembershipReadAllAsync(this.clusterId);
            }
            catch (Exception ex)
            {
        ...
        public async Task<bool> InsertRow(MembershipEntry entry, TableVersion tableVersion)
        {
            ...
            //exist for the sake of robustness) as mandated by Scynapse membership protocol.
            ...
            try
            {
                return await scynapseQueries.InsertMembershipRowAsync(this.clusterId, entry, tableVersion.VersionEtag);
            }
            catch (Exception ex)
            {
        ...
        public async Task<bool> UpdateRow(MembershipEntry entry, string etag, TableVersion tableVersion)
        {
            ...
            try
            {
                return await scynapseQueries.UpdateMembershipRowAsync(this.clusterId, entry, tableVersion.VersionEtag);
            }
            catch (Exception ex)
            {
        ...
        public async Task UpdateIAmAlive(MembershipEntry entry)
        {
            ...
            try
            {
                await scynapseQueries.UpdateIAmAliveTimeAsync(this.clusterId, entry.SiloAddress, entry.IAmAliveTime);
            }
            catch (Exception ex)
            {
        ...
        public async Task DeleteMembershipTableEntries(string clusterId)
        {
            ...
            try
            {
                await scynapseQueries.DeleteMembershipTableEntriesAsync(clusterId);
            }
            catch (Exception ex)
            {
        ...
        public async Task CleanupDefunctSiloEntries(DateTimeOffset beforeDate)
        {
            ...
            try
            {
                await scynapseQueries.CleanupDefunctSiloEntriesAsync(beforeDate, this.clusterId);
            }
            catch (Exception ex)
            {
        ...
        private async Task<bool> InitTableAsync()
        {
            try
            {
                return await scynapseQueries.InsertMembershipVersionRowAsync(this.clusterId);
            }
            catch (Exception ex)
            {
