...
using Scynapse.Dashboard.Metrics.TypeFormatting;
using System;
...
namespace Scynapse.Dashboard.Metrics;
    ...
    IOptions<GrainProfilerOptions> options) : IGrainProfiler, ILifecycleParticipant<ISiloLifecycle>
{
    ...
    public void Track(double elapsedMs, Type grainType, [CallerMemberName] string methodName = null, bool failed = false)
    {
        ...
        // This is the method that Scynapse uses to convert a grain type into the grain type name when calling the GetSimpleGrainStatistics method
