...
internal sealed class SiloGrainService : GrainService, ISiloGrainService
{
    ...
    private string _versionScynapse;
    ...
    public override async Task Start()
    {
        ...
        {
            _logger.LogWarning("Not running in Scynapse runtime");
        }
    ...
    public Task SetVersion(string scynapse, string host)
    {
        _versionScynapse = scynapse;
        _versionHost = host;
    ...
    public Task<Immutable<Dictionary<string, string>>> GetExtendedProperties()
    {
        var results = new Dictionary<string, string>
        {
            ...
            ["ScynapseVersion"] = _versionScynapse
        };
