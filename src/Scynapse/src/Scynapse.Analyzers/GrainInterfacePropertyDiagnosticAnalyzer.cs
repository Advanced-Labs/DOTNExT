...
namespace Scynapse.Analyzers
{
    ...
    {
        private const string BaseInterfaceName = "Scynapse.Runtime.IAddressable";
        public const string DiagnosticId = "SCYNAPSE0008";
        ...
        private const string StateTaskTypeName = "Scynapse.StateTask";
