...
namespace Scynapse.Configuration
{
    ...
    public class RedisGrainDirectoryOptionsValidator : IConfigurationValidator
    {
        ...
        public void ValidateConfiguration()
        {
            ...
            {
                throw new ScynapseConfigurationException($"Invalid configuration for {nameof(RedisGrainDirectory)} with name {_name}. {nameof(RedisGrainDirectoryOptions)}.{nameof(_options.ConfigurationOptions)} is required.");
            }
        }
    }
}
