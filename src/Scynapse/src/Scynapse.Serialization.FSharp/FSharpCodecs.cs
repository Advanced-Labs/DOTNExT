...
namespace Scynapse.Serialization
{
    ...
    public sealed class FSharpOptionCodec<T> : IFieldCodec<FSharpOption<T>>
    {
        ...
        {
            _fieldCodec = ScynapseGeneratedCodeHelper.UnwrapService(this, fieldCodec);
        }
    ...
    public sealed class FSharpOptionCopier<T> : IDeepCopier<FSharpOption<T>>
    {
        ...
        {
            _valueCopier = ScynapseGeneratedCodeHelper.UnwrapService(this, valueCopier);
        }
    ...
    public class FSharpValueOptionCodec<T> : IFieldCodec<FSharpValueOption<T>>
    {
        ...
        {
            _valueCodec = ScynapseGeneratedCodeHelper.UnwrapService(this, item1Codec);
        }
