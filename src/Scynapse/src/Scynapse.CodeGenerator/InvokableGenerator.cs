...
namespace Scynapse.CodeGenerator
{
    ...
    internal class InvokableGenerator
    {
        ...
        private INamedTypeSymbol GetBaseClassType(InvokableMethodDescription method)
        {
            ...
            {
                throw new ScynapseGeneratorDiagnosticAnalysisException(InvalidRpcMethodReturnTypeDiagnostic.CreateDiagnostic(method));
            }
            ...
            List<InvokerFieldDescription> fields)
        {
            ...
            // C#: default: return ScynapseGeneratedCodeHelper.InvokableThrowArgumentOutOfRange(index, {maxArgs})
            var throwHelperMethod = MemberAccessExpression(
                SyntaxKind.SimpleMemberAccessExpression,
                IdentifierName("ScynapseGeneratedCodeHelper"),
            ...
            List<InvokerFieldDescription> fields)
        {
            ...
            // C#: default: ScynapseGeneratedCodeHelper.InvokableThrowArgumentOutOfRange(index, {maxArgs})
                ...
                if (description is MethodInfoFieldDescription methodInfo)
                {
                    ...
                    field = FieldDeclaration(
                        VariableDeclaration(
                            ...
                            .WithInitializer(EqualsValueClause(
                                InvocationExpression(
                                    IdentifierName("ScynapseGeneratedCodeHelper").Member("GetMethodInfoOrDefault"),
                                    ArgumentList(SeparatedList(new[]
                                    {
