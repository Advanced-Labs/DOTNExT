...
{
    /// <summary>
    /// Generates code for Scynapse Events on grains.
    ///
    ...
    internal class EventCodeGenerator
    {
        ...
        /// <summary>
        /// Grain key types supported by Scynapse.
        /// </summary>
        ...
        public MemberDeclarationSyntax[] GenerateGrainMembers(IEnumerable<EventDescription> events)
        {
            ...
            // Generate __InitializeScynapseEvents method
            members.Add(GenerateInitializeMethod(eventsList));

            // Generate __CleanupScynapseEvents method
        ...
        private MethodDeclarationSyntax GenerateInterfaceSubscribeMethod(EventDescription evt, bool withHandler)
        {
            ...
            var subscriptionType = GenericName(
                Identifier("global::Scynapse.IEventSubscription"),
        ...
        private FieldDeclarationSyntax GenerateStreamField(EventDescription evt)
        {
            ...
            var streamType = NullableType(GenericName(
                Identifier("global::Scynapse.Streams.IAsyncStream"),
                TypeArgumentList(SingletonSeparatedList(payloadTypeSyntax))));
        ...
        private MethodDeclarationSyntax GenerateParticipateMethod(List<EventDescription> events)
        {
            ...
            var subscribeCall = InvocationExpression(
                ...
                .WithArgumentList(ArgumentList(SeparatedList(new[]
                {
                    Argument(MemberAccessExpression(
                        SyntaxKind.SimpleMemberAccessExpression,
                        ParseTypeName("global::Scynapse.Runtime.GrainLifecycleStage"),
                        IdentifierName("Activate"))),
                    Argument(SimpleLambdaExpression(
                        Parameter(Identifier("ct")),
                        Block(
                            ExpressionStatement(InvocationExpression(IdentifierName("__InitializeScynapseEvents"))),
                    ...
                    Argument(SimpleLambdaExpression(
                        Parameter(Identifier("ct")),
                        Block(
                            ExpressionStatement(InvocationExpression(IdentifierName("__CleanupScynapseEvents"))),
                            ReturnStatement(MemberAccessExpression(
                                SyntaxKind.SimpleMemberAccessExpression,
                                ParseTypeName("global::System.Threading.Tasks.Task"),
                                IdentifierName("CompletedTask"))))))
            ...
            return MethodDeclaration(
                ...
                .WithExplicitInterfaceSpecifier(ExplicitInterfaceSpecifier(
                    GenericName(
                        Identifier("global::Scynapse.ILifecycleParticipant"),
                        TypeArgumentList(SingletonSeparatedList<TypeSyntax>(
                            ParseTypeName("global::Scynapse.Runtime.IGrainLifecycle"))))))
                .WithParameterList(ParameterList(SingletonSeparatedList(
                    Parameter(Identifier("lifecycle"))
                        .WithType(ParseTypeName("global::Scynapse.Runtime.IGrainLifecycle")))))
        ...
        private MethodDeclarationSyntax GenerateInitializeMethod(List<EventDescription> events)
        {
                        ...
                        .AddVariables(VariableDeclarator(streamIdVarName)
                            .WithInitializer(EqualsValueClause(
                                InvocationExpression(
                                    MemberAccessExpression(
                                        SyntaxKind.SimpleMemberAccessExpression,
                                        ParseTypeName("global::Scynapse.Runtime.StreamId"),
            ...
            return MethodDeclaration(
                PredefinedType(Token(SyntaxKind.VoidKeyword)),
                Identifier("__InitializeScynapseEvents"))
                .WithModifiers(TokenList(Token(SyntaxKind.PrivateKeyword)))
                .WithBody(Block(statements));
        }
        ...
        private MethodDeclarationSyntax GenerateCleanupMethod(List<EventDescription> events)
        {
            ...
            return MethodDeclaration(
                PredefinedType(Token(SyntaxKind.VoidKeyword)),
                Identifier("__CleanupScynapseEvents"))
                .WithModifiers(TokenList(Token(SyntaxKind.PrivateKeyword)))
                .WithBody(Block(statements));
        }
        ...
        private MethodDeclarationSyntax GenerateProxySubscribeMethod(EventDescription evt, bool withHandler)
        {
            ...
            var tokenType = ParseTypeName("global::Scynapse.Streams.StreamSequenceToken");
            ...
            // var handle = await Scynapse.Streams.AsyncObservableExtensions.SubscribeAsync(stream, lambda);
            statements.Add(LocalDeclarationStatement(
                VariableDeclaration(IdentifierName("var"))
                        ...
                        .WithInitializer(EqualsValueClause(
                            AwaitExpression(
                                InvocationExpression(
                                    MemberAccessExpression(
                                        SyntaxKind.SimpleMemberAccessExpression,
                                        ParseTypeName("global::Scynapse.Streams.AsyncObservableExtensions"),
            ...
            statements.Add(ReturnStatement(
                ObjectCreationExpression(
                    GenericName(
                        Identifier("global::Scynapse.Streaming.EventSubscription"),
                        TypeArgumentList(SingletonSeparatedList(payloadTypeSyntax))))
                    .WithArgumentList(ArgumentList(SeparatedList(new[]
                    {
                            ...
                            InvocationExpression(
                                MemberAccessExpression(
                                    ...
                                    GenericName(
                                        ...
                                        TypeArgumentList(SingletonSeparatedList<TypeSyntax>(
                                            ParseTypeName("global::Scynapse.Streams.IStreamProvider"))))))
                                .WithArgumentList(ArgumentList(SeparatedList(new[]
                                {
                                    Argument(MemberAccessExpression(
                                        SyntaxKind.SimpleMemberAccessExpression,
        ...
        private GrainKeyType? GetGrainKeyType(INamedTypeSymbol grainClass)
        {
            ...
            {
                var name = iface.ToDisplayString();
                if (name == "Scynapse.IGrainWithStringKey") return GrainKeyType.String;
                if (name == "Scynapse.IGrainWithGuidKey") return GrainKeyType.Guid;
                if (name == "Scynapse.IGrainWithIntegerKey") return GrainKeyType.Integer;
                if (name == "Scynapse.IGrainWithGuidCompoundKey") return GrainKeyType.GuidCompound;
                if (name == "Scynapse.IGrainWithIntegerCompoundKey") return GrainKeyType.IntegerCompound;
            }
            return null;
        }
