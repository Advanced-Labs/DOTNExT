...
using static Scynapse.CodeGenerator.CopierGenerator;
...
namespace Scynapse.CodeGenerator
{
    ...
    internal class ProxyGenerator
    {
        ...
        public (ClassDeclarationSyntax, GeneratedProxyDescription) Generate(ProxyInterfaceDescription interfaceDescription)
        {
            ...
            // Add event support (Scynapse Events)
            ...
            List<StatementSyntax> GetBodyStatements()
            {
                ...
                static ExpressionSyntax Unwrapped(ExpressionSyntax expr)
                {
                    return InvocationExpression(
                        MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, IdentifierName("ScynapseGeneratedCodeHelper"), IdentifierName("UnwrapService")),
                ...
                {
                    return InvocationExpression(
                        MemberAccessExpression(SyntaxKind.SimpleMemberAccessExpression, IdentifierName("ScynapseGeneratedCodeHelper"), GenericName(Identifier("GetService"), TypeArgumentList(SingletonSeparatedList(type)))),
