...
public static class IncorrectProxyBaseClassSpecificationDiagnostic
{
    ...
    private static readonly LocalizableString Description = "Proxy base clases must conform. Please report this bug by opening an issue https://github.com/Scynapse/Core/issues/new.";
