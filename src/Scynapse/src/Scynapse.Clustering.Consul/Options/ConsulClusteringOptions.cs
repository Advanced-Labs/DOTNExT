...
namespace Scynapse.Configuration
{
    ...
    {        
        ...
        internal void Validate(string name)
        {
            ...
            {
                throw new ScynapseConfigurationException($"No callback specified. Use the {GetType().Name}.{nameof(ConsulClusteringOptions.ConfigureConsulClient)} method to configure the consul client.");
            }                       
        }
    }
