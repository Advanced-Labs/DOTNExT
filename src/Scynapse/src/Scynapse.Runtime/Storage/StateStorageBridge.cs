...
namespace Scynapse.Core
{
    ...
    public partial class StateStorageBridge<TState> : IStorage<TState>, IGrainMigrationParticipant
    {
        ...
        private void OnError(Exception exception, ErrorCode id, string operation)
        {
            ...
            // If error is not specialization of ScynapseException, wrap it
            if (exception is not ScynapseException)
            {
                ...
                throw new ScynapseException(errMsg, exception);
            }
