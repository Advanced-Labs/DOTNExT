...
namespace Scynapse.Runtime.Development
{
    /// <summary>
    ...
    internal class DevelopmentLeaseProviderGrain : Grain, IDevelopmentLeaseProviderGrain
    {
        ...
        private AcquireLeaseResult Acquire(string category, LeaseRequest leaseRequest)
        {
            ...
            return new AcquireLeaseResult(new AcquiredLease(leaseRequest.ResourceKey), ResponseCode.LeaseNotAvailable, new ScynapseException("Lease not available"));
        }
        ...
        private AcquireLeaseResult Renew(string category, AcquiredLease acquiredLease)
        {
            ...
            {
                return new AcquireLeaseResult(new AcquiredLease(acquiredLease.ResourceKey), ResponseCode.InvalidToken, new ScynapseException("Invalid token provided, caller is not the owner."));
            }
