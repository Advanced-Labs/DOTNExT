...
namespace Scynapse.Runtime.Placement
{
    internal class SiloRoleBasedPlacementDirector : IPlacementDirector
    {
            ...
            PlacementStrategy strategy, PlacementTarget target, IPlacementContext context)
        {
            ...
            {
                throw new ScynapseException($"Cannot place grain with RoleName {siloRole}. Either Role name is invalid or there are no active silos with type {siloRole} in MembershipTableSnapshot registered yet.");
            }
