...
{
    protected static readonly GrainInterfaceType InvokableInterfaceType = GrainInterfaceType.Create("Scynapse.Runtime.IGrainTimerInvoker");
    ...
    private static void ThrowInvalidSchedulingContext()
    {
        throw new InvalidSchedulingContextException(
            "Current grain context is null. "
             + "Please make sure you are not trying to create a Timer from outside Scynapse Task Scheduler, "
