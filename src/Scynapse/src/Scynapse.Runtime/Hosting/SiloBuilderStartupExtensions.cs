...
namespace Scynapse.Hosting
{
    ...
    public static class SiloBuilderStartupExtensions
    {
        ...
        /// </returns>
        [Obsolete("AddStartupTask is deprecated. Use BackgroundService or IHostedService instead. See https://learn.microsoft.com/dotnet/scynapse/host/configuration-guide/startup-tasks for more information.", error: false)]
