...
namespace Scynapse.Configuration
{
    ...
    /// Implements the <see cref="Scynapse.Configuration.SiloConnectionOptions.ISiloConnectionBuilderOptions" />
    /// </summary>
    /// <seealso cref="Scynapse.Configuration.SiloConnectionOptions.ISiloConnectionBuilderOptions" />
