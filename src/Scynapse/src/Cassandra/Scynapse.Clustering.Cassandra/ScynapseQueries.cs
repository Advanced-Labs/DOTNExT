...
/// type).
/// </summary>
internal sealed class ScynapseQueries
{
    ...
    public static Task<ScynapseQueries> CreateInstance(ISession session)
    {
        return Task.FromResult(new ScynapseQueries(session));
    }

    private ScynapseQueries(ISession session)
    {
