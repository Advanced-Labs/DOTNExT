    ...
    internal partial class DynamoDBMembershipTable : IMembershipTable
    {
        ...
        private static MembershipEntry Parse(SiloInstanceRecord tableEntry)
        {
            ...
            if (suspectingSilos.Count != suspectingTimes.Count)
                throw new ScynapseException($"SuspectingSilos.Length of {suspectingSilos.Count} as read from Azure table is not equal to SuspectingTimes.Length of {suspectingTimes.Count}");
