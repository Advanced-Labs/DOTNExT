# Microsoft Scynapse Streaming for Amazon SQS

## Introduction
Microsoft Scynapse Streaming for Amazon SQS provides a stream provider implementation for Scynapse using Amazon Simple Queue Service (SQS). This allows for publishing and subscribing to streams of events with SQS as the underlying messaging infrastructure.

## Getting Started
To use this package, install it via NuGet:

```shell
dotnet add package Genesa.Scynapse.Streaming.SQS
```
