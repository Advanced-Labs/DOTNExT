...
namespace Scynapse
{
    ...
    public sealed class GenerateSerializerAttribute : Attribute
    {
        ...
        /// <summary>
        /// Get or sets when Scynapse should auto-assign field ids. The default behavior is to not auto-assign field ids.
        /// </summary>
    ...
    public sealed class ScynapseConstructorAttribute : ActivatorUtilitiesConstructorAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScynapseConstructorAttribute"/> class.
        /// </summary>
        public ScynapseConstructorAttribute()
        {
        }
    }
