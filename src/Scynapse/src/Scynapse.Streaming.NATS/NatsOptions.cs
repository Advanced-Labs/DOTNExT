...
public class NatsOptions
{
    ...
    /// If not provided, a default client will be created with the name Scynapse-{providerName}
    ...
    /// This determines the number of pooling agents that will be created on this Scynapse Cluster.
