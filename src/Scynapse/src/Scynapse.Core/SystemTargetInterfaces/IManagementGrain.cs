...
namespace Scynapse.Runtime
{
    ...
    public interface IManagementGrain : IGrainWithIntegerKey, IVersionManager
    {
        ...
        /// <summary>Perform a run of the Scynapse activation collector in the specified silos.</summary>
        /// <param name="hostsIds">List of silos this command is to be sent to.</param>
        ...
        /// </summary>
        /// <remarks>
        /// Providers must implement the <c>Scynapse.Providers.IControllable</c>
        ...
        /// This is an opaque value to the Scynapse runtime - the control protocol semantics are decided between the sender and provider.</param>
        ...
        /// <summary>
        /// Return the <see cref="Scynapse.Runtime.SiloAddress"/> where a given Grain is activated (if any).
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <param name="reference">The <see cref="Scynapse.Runtime.IAddressable"/> to look up.</param>
        /// <returns>The <see cref="Scynapse.Runtime.SiloAddress"/> where the Grain is activated or null if not activated taken from a snapshot of the last known state of the Grain Catalog.</returns>
    ...
    /// </summary>
    [GenerateSerializer]
    [Alias("Scynapse.Runtime.GrainCallFrequency")]
    [Immutable]
