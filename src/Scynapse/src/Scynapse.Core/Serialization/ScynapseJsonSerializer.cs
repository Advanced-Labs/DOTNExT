...
namespace Scynapse.Serialization
{
    ...
    /// <summary>
    /// Utility class for configuring <see cref="JsonSerializerSettings"/> to support Scynapse types.
    /// </summary>
    public class ScynapseJsonSerializer
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScynapseJsonSerializer"/> class.
        /// </summary>
        public ScynapseJsonSerializer(IOptions<ScynapseJsonSerializerOptions> options)
        {
