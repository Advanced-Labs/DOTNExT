...
using static Scynapse.Runtime.Message;
...
namespace Scynapse.Runtime.Messaging
{
    internal sealed class MessageSerializer
    {
            ...
            MessagingOptions options)
        {
            ...
            _requestContextCodec = ScynapseGeneratedCodeHelper.GetService<DictionaryCodec<string, object>>(this, sessionPool.CodecProvider);
            _activationAddressCodec = ScynapseGeneratedCodeHelper.GetService<IFieldCodec<GrainAddressCacheUpdate>>(this, sessionPool.CodecProvider);
