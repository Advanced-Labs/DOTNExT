    ...
    internal partial class GatewayManager : IDisposable
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            if (knownGateways.Count == 0)
            {
                ...
                var message = $"Could not find any gateway in '{providerName}'. Scynapse client cannot initialize until at least one gateway becomes available.";
        ...
        [LoggerMessage(
            ...
            Message = "Could not find any gateway in '{GatewayListProviderName}'. Scynapse client cannot initialize until at least one gateway becomes available."
        )]
