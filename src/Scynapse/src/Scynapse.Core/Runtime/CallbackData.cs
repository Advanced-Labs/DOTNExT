...
namespace Scynapse.Runtime
{
    internal sealed partial class CallbackData
    {
        ...
        private void OnCancellation()
        {
            ...
            ScynapseCallBackDataEvent.Log.OnCanceled(Message);
        ...
        public void OnTimeout()
        {
            ...
            ScynapseCallBackDataEvent.Log.OnTimeout(this.Message);
        ...
        public void OnTargetSiloFail()
        {
            ...
            ScynapseCallBackDataEvent.Log.OnTargetSiloFail(this.Message);
        ...
        public void DoCallback(Message response)
        {
            ...
            ScynapseCallBackDataEvent.Log.DoCallback(this.Message);
        ...
        private static void ResponseCallback(Message message, IResponseCompletionSource context)
        {
            ...
            static void HandleRejectionResponse(IResponseCompletionSource context, RejectionResponse? rejection)
            {
                ...
                {
                    exception = rejection?.Exception ?? new ScynapseMessageRejectionException(rejection?.RejectionInfo ?? "Unable to send request - no rejection info available");
                }
