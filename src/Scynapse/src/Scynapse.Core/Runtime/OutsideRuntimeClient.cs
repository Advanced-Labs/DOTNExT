...
using Scynapse.ClientObservers;
...
using static Scynapse.Internal.StandardExtensions;
...
namespace Scynapse
{
    internal partial class OutsideRuntimeClient : IRuntimeClient, IDisposable, IClusterConnectionStatusListener
    {
        ...
        public void SendResponse(Message request, Response response)
        {
            ...
            ScynapseOutsideRuntimeClientEvent.Log.SendResponse(message);
        ...
        public void SendRequest(GrainReference target, IInvokable request, IResponseCompletionSource context, InvokeMethodOptions options)
        {
            ...
            ScynapseOutsideRuntimeClientEvent.Log.SendRequest(message);
        ...
        {
            ScynapseOutsideRuntimeClientEvent.Log.ReceiveResponse(response);
        ...
        [LoggerMessage(
            ...
            Message = "Starting Scynapse client with runtime version '{RuntimeVersion}', local address '{LocalAddress}' and client id '{ClientId}'."
        )]
