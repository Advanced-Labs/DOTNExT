...
namespace Scynapse.Configuration
{
    ...
    public sealed class GrainTypeOptionsValidator : IConfigurationValidator
    {
        ...
        public void ValidateConfiguration()
        {
            ...
            {
                throw new ScynapseConfigurationException($"No grain interfaces have been configured. Either add some grain interfaces and reference the Scynapse.Sdk package, or remove {nameof(GrainTypeOptionsValidator)} from the services collection.");
            }
            ...
            if (isSilo)
            {
                ...
                {
                    throw new ScynapseConfigurationException($"No grain classes have been configured. Either add some grain classes and reference the Scynapse.Sdk package, or remove {nameof(GrainTypeOptionsValidator)} from the services collection.");
                }
            }
        }
    }
