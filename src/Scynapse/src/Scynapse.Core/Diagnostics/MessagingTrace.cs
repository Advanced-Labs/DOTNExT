...
namespace Scynapse.Runtime
{
    ...
    {
        public const string Category = "Scynapse.Messaging";
        ...
        public void OnIncomingMessageAgentReceiveMessage(Message message)
        {
            ...
            ScynapseIncomingMessageAgentEvent.Log.ReceiveMessage(message);
        ...
        public void OnDispatcherReceiveMessage(Message message)
        {
            ...
            ScynapseDispatcherEvent.Log.ReceiveMessage(message);
        ...
        {
            ScynapseInsideRuntimeClientEvent.Log.SendRequest(message);
        }
