...
namespace Scynapse.Hosting
{
    ...
    {
        /// <summary>
        /// Configures the provided delegate as a connection retry filter, used to determine whether initial connection to the Scynapse cluster should be retried after a failure.
        /// </summary>
        ...
        /// <summary>
        /// Configures the provided <typeparamref name="TConnectionRetryFilter"/> type as a connection retry filter, used to determine whether initial connection to the Scynapse cluster should be retried after a failure.
        /// </summary>
        /// <param name="builder">The host builder.</param>
        /// <returns>The same instance of the <see cref="IClientBuilder"/> for chaining.</returns>
