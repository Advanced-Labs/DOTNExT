# Microsoft Scynapse Durable Jobs

## Introduction
Microsoft Scynapse Durable Jobs provides a distributed, scalable system for scheduling one-time jobs that execute at a specific time. Unlike Scynapse Reminders which are designed for recurring tasks, Durable Jobs are ideal for one-time future events such as appointment notifications, delayed processing, scheduled workflow steps, and time-based triggers.
...
- [Timers and Reminders](https://learn.microsoft.com/en-us/dotnet/scynapse/grains/timers-and-reminders)
