...
using Scynapse.Serialization.Buffers.Adaptors;
...
namespace Scynapse.Serialization
{
    ...
    public sealed class Serializer<T>
    {
        ...
        /// </summary>
        /// <param name="sessionPool">The session pool.</param>
        public Serializer(SerializerSessionPool sessionPool) : this(ScynapseGeneratedCodeHelper.UnwrapService(null, sessionPool.CodecProvider.GetCodec<T>()), sessionPool)
        {
        }
    ...
    public sealed class ValueSerializer<T> where T : struct
    {
        ...
        {
            _sessionPool = sessionPool;
            _codec = ScynapseGeneratedCodeHelper.UnwrapService(null, codecProvider.GetValueSerializer<T>());
        }
