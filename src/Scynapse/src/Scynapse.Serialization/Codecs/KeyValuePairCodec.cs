...
namespace Scynapse.Serialization.Codecs
{
    ...
    public sealed class KeyValuePairCodec<TKey, TValue> : IFieldCodec<KeyValuePair<TKey, TValue>>
    {
        ...
        {
            _keyCodec = ScynapseGeneratedCodeHelper.UnwrapService(this, keyCodec);
    ...
    public sealed class KeyValuePairCopier<TKey, TValue> : IDeepCopier<KeyValuePair<TKey, TValue>>, IOptionalDeepCopier
    {
        ...
        {
            _keyCopier = ScynapseGeneratedCodeHelper.GetOptionalCopier(keyCopier);
            _valueCopier = ScynapseGeneratedCodeHelper.GetOptionalCopier(valueCopier);
        }
