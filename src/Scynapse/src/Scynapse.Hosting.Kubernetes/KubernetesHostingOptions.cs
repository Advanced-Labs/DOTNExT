...
namespace Scynapse.Hosting.Kubernetes
{
    /// <summary>
    ...
    public sealed class KubernetesHostingOptions
    {
        ...
        /// <summary>
        /// The environment variable for specifying <see cref="Scynapse.Configuration.ClusterOptions.ClusterId"/>.
        /// </summary>
        public const string ClusterIdEnvironmentVariable = "SCYNAPSE_CLUSTER_ID";

        /// <summary>
        /// The environment variable for specifying <see cref="Scynapse.Configuration.ClusterOptions.ServiceId"/>.
        /// </summary>
        public const string ServiceIdEnvironmentVariable = "SCYNAPSE_SERVICE_ID";

        /// <summary>
        /// The name of the <see cref="Scynapse.Configuration.ClusterOptions.ServiceId"/> label on the pod.
        /// </summary>
        public const string ServiceIdLabel = "scynapse/serviceId";

        /// <summary>
        /// The name of the <see cref="Scynapse.Configuration.ClusterOptions.ClusterId"/> label on the pod.
        /// </summary>
        public const string ClusterIdLabel = "scynapse/clusterId";
