...
{
    public partial class AzureQueueAdapterFactory : Scynapse.Streams.IQueueAdapterFactory
    {
        public AzureQueueAdapterFactory(string name, Configuration.AzureQueueOptions options, Configuration.SimpleQueueCacheOptions cacheOptions, Scynapse.Streams.IQueueDataAdapter<string, Scynapse.Streams.IBatchContainer> dataAdapter, Microsoft.Extensions.Logging.ILoggerFactory loggerFactory) { }
    ...
    public partial class AzureQueueDataAdapterV1 : Scynapse.Streams.IQueueDataAdapter<string, Scynapse.Streams.IBatchContainer>, Scynapse.Streams.IQueueDataAdapter<string>, Serialization.IOnDeserialized
    {
        public AzureQueueDataAdapterV1(Serialization.Serializer serializer) { }

        public Scynapse.Streams.IBatchContainer FromQueueMessage(string cloudMsg, long sequenceId) { throw null; }

        void Serialization.IOnDeserialized.OnDeserialized(Serialization.DeserializationContext context) { }

        public string ToQueueMessage<T>(Runtime.StreamId streamId, System.Collections.Generic.IEnumerable<T> events, Scynapse.Streams.StreamSequenceToken token, System.Collections.Generic.Dictionary<string, object> requestContext) { throw null; }
    }

    [SerializationCallbacks(typeof(Runtime.OnDeserializedCallbacks))]
    public partial class AzureQueueDataAdapterV2 : Scynapse.Streams.IQueueDataAdapter<string, Scynapse.Streams.IBatchContainer>, Scynapse.Streams.IQueueDataAdapter<string>, Serialization.IOnDeserialized
    {
...
{
    public partial class AzureTableStorageStreamFailureHandler<TEntity> : Scynapse.Streams.IStreamFailureHandler where TEntity : StreamDeliveryFailureEntity, new()
    {
        public AzureTableStorageStreamFailureHandler(Serialization.Serializer<Scynapse.Streams.StreamSequenceToken> serializer, Microsoft.Extensions.Logging.ILoggerFactory loggerFactory, bool faultOnFailure, string clusterId, Streaming.AzureStorage.AzureStorageOperationOptions azureStorageOptions, System.Func<TEntity> createEntity = null) { }

        public bool ShouldFaultSubsriptionOnError { get { throw null; } }

        public System.Threading.Tasks.Task InitAsync() { throw null; }

        public System.Threading.Tasks.Task OnDeliveryFailure(Runtime.GuidId subscriptionId, string streamProviderName, Runtime.StreamId streamId, Scynapse.Streams.StreamSequenceToken sequenceToken) { throw null; }

        public System.Threading.Tasks.Task OnSubscriptionFailure(Runtime.GuidId subscriptionId, string streamProviderName, Runtime.StreamId streamId, Scynapse.Streams.StreamSequenceToken sequenceToken) { throw null; }
    }
    ...
    public partial class StreamDeliveryFailureEntity : Azure.Data.Tables.ITableEntity
    {
        ...
        public virtual Scynapse.Streams.StreamSequenceToken GetSequenceToken(Serialization.Serializer<Scynapse.Streams.StreamSequenceToken> serializer) { throw null; }
        ...
        public virtual void SetSequenceToken(Serialization.Serializer<Scynapse.Streams.StreamSequenceToken> serializer, Scynapse.Streams.StreamSequenceToken token) { }
    }
}
