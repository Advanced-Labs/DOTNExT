...
namespace Scynapse.Providers
{
    ...
    public partial class MemoryAdapterFactory<TSerializer> : Scynapse.Streams.IQueueAdapterFactory, Scynapse.Streams.IQueueAdapter, Scynapse.Streams.IQueueAdapterCache where TSerializer : class, IMemoryMessageBodySerializer
    {
        ...
        public Scynapse.Streams.StreamProviderDirection Direction { get { throw null; } }

        public bool IsRewindable { get { throw null; } }

        public string Name { get { throw null; } }

        protected System.Func<string, System.Threading.Tasks.Task<Scynapse.Streams.IStreamFailureHandler>> StreamFailureHandlerFactory { get { throw null; } set { } }

        public static MemoryAdapterFactory<TSerializer> Create(System.IServiceProvider services, string name) { throw null; }

        public System.Threading.Tasks.Task<Scynapse.Streams.IQueueAdapter> CreateAdapter() { throw null; }

        public Scynapse.Streams.IQueueCache CreateQueueCache(Scynapse.Streams.QueueId queueId) { throw null; }

        public Scynapse.Streams.IQueueAdapterReceiver CreateReceiver(Scynapse.Streams.QueueId queueId) { throw null; }
        ...
        public Scynapse.Streams.IQueueAdapterCache GetQueueAdapterCache() { throw null; }

        public Scynapse.Streams.IStreamQueueMapper GetStreamQueueMapper() { throw null; }

        public void Init() { }

        public System.Threading.Tasks.Task QueueMessageBatchAsync<T>(Runtime.StreamId streamId, System.Collections.Generic.IEnumerable<T> events, Scynapse.Streams.StreamSequenceToken token, System.Collections.Generic.Dictionary<string, object> requestContext) { throw null; }
    }
    ...
    public partial class MemoryPooledCache<TSerializer> : Scynapse.Streams.IQueueCache, Scynapse.Streams.IQueueFlowController, Streams.Common.ICacheDataAdapter where TSerializer : class, IMemoryMessageBodySerializer
    {
        ...
        public void AddToCache(System.Collections.Generic.IList<Scynapse.Streams.IBatchContainer> messages) { }

        public Scynapse.Streams.IBatchContainer GetBatchContainer(ref Streams.Common.CachedMessage cachedMessage) { throw null; }

        public Scynapse.Streams.IQueueCacheCursor GetCacheCursor(Runtime.StreamId streamId, Scynapse.Streams.StreamSequenceToken token) { throw null; }

        public int GetMaxAddCount() { throw null; }

        public Scynapse.Streams.StreamSequenceToken GetSequenceToken(ref Streams.Common.CachedMessage cachedMessage) { throw null; }

        public bool IsUnderPressure() { throw null; }

        public bool TryPurgeFromCache(out System.Collections.Generic.IList<Scynapse.Streams.IBatchContainer> purgedItems) { throw null; }
    }
...
namespace Scynapse.Providers.Streams.Common
{
    ...
    public partial class CachedMessageBlock : PooledResource<CachedMessageBlock>
    {
        ...
        public int GetIndexOfFirstMessageLessThanOrEqualTo(Scynapse.Streams.StreamSequenceToken token) { throw null; }

        public Scynapse.Streams.StreamSequenceToken GetNewestSequenceToken(ICacheDataAdapter dataAdapter) { throw null; }

        public Scynapse.Streams.StreamSequenceToken GetOldestSequenceToken(ICacheDataAdapter dataAdapter) { throw null; }

        public Scynapse.Streams.StreamSequenceToken GetSequenceToken(int index, ICacheDataAdapter dataAdapter) { throw null; }
    ...
    {
        public static int Compare(this ref CachedMessage cachedMessage, Scynapse.Streams.StreamSequenceToken token) { throw null; }
    ...
    [GenerateSerializer]
    public partial class EventSequenceToken : Scynapse.Streams.StreamSequenceToken
    {
        ...
        public override int CompareTo(Scynapse.Streams.StreamSequenceToken other) { throw null; }

        public EventSequenceToken CreateSequenceTokenForEvent(int eventInd) { throw null; }

        public override bool Equals(Scynapse.Streams.StreamSequenceToken other) { throw null; }
    ...
    [GenerateSerializer]
    public partial class EventSequenceTokenV2 : Scynapse.Streams.StreamSequenceToken
    {
    ...
    {
        Scynapse.Streams.IBatchContainer GetBatchContainer(ref CachedMessage cachedMessage);
        Scynapse.Streams.StreamSequenceToken GetSequenceToken(ref CachedMessage cachedMessage);
    }
    ...
    public partial class PersistentStreamProvider : Scynapse.Streams.IStreamProvider, IControllable, Scynapse.Streams.Core.IStreamSubscriptionManagerRetriever, ILifecycleParticipant<ILifecycleObservable>
    {
        ...
        public static Scynapse.Streams.IStreamProvider Create(System.IServiceProvider services, string name) { throw null; }

        public System.Threading.Tasks.Task<object> ExecuteCommand(int command, object arg) { throw null; }

        public Scynapse.Streams.IAsyncStream<T> GetStream<T>(Runtime.StreamId streamId) { throw null; }

        public Scynapse.Streams.Core.IStreamSubscriptionManager GetStreamSubscriptionManager() { throw null; }
    ...
    public partial class PooledQueueCache : IPurgeObservable
    {
        ...
        public object GetCursor(Runtime.StreamId streamId, Scynapse.Streams.StreamSequenceToken sequenceToken) { throw null; }

        public void RemoveOldestMessage() { }

        public bool TryGetNextMessage(object cursorObj, out Scynapse.Streams.IBatchContainer message) { throw null; }
    }
    ...
    public partial class SimpleQueueAdapterCache : Scynapse.Streams.IQueueAdapterCache
    {
    ...
    public partial class SimpleQueueCache : Scynapse.Streams.IQueueCache, Scynapse.Streams.IQueueFlowController
    {
        public SimpleQueueCache(int cacheSize, Microsoft.Extensions.Logging.ILogger logger) { }

        public int Size { get { throw null; } }

        public virtual void AddToCache(System.Collections.Generic.IList<Scynapse.Streams.IBatchContainer> msgs) { }

        public virtual Scynapse.Streams.IQueueCacheCursor GetCacheCursor(Runtime.StreamId streamId, Scynapse.Streams.StreamSequenceToken token) { throw null; }

        public int GetMaxAddCount() { throw null; }

        public virtual bool IsUnderPressure() { throw null; }

        public virtual bool TryPurgeFromCache(out System.Collections.Generic.IList<Scynapse.Streams.IBatchContainer> purgedItems) { throw null; }
    }

    public partial class SimpleQueueCacheCursor : Scynapse.Streams.IQueueCacheCursor, System.IDisposable
    {
        ...
        public virtual Scynapse.Streams.IBatchContainer GetCurrent(out System.Exception exception) { throw null; }

        public virtual bool MoveNext() { throw null; }

        public void RecordDeliveryFailure() { }

        public virtual void Refresh(Scynapse.Streams.StreamSequenceToken sequenceToken) { }
...
{
    [GenerateSerializer]
    public sealed partial class GeneratedBatchContainer : Scynapse.Streams.IBatchContainer
    {
        ...
        public Scynapse.Streams.StreamSequenceToken SequenceToken { get { throw null; } }

        [Id(0)]
        public Runtime.StreamId StreamId { get { throw null; } }

        public System.Collections.Generic.IEnumerable<System.Tuple<T, Scynapse.Streams.StreamSequenceToken>> GetEvents<T>() { throw null; }
    ...
    public partial class GeneratorAdapterFactory : Scynapse.Streams.IQueueAdapterFactory, Scynapse.Streams.IQueueAdapter, Scynapse.Streams.IQueueAdapterCache, IControllable
    {
    ...
    public partial class GeneratorPooledCache : Scynapse.Streams.IQueueCache, Scynapse.Streams.IQueueFlowController, Common.ICacheDataAdapter
    {
        ...
        public Scynapse.Streams.IBatchContainer GetBatchContainer(ref Common.CachedMessage cachedMessage) { throw null; }

        public Scynapse.Streams.IQueueCacheCursor GetCacheCursor(Runtime.StreamId streamId, Scynapse.Streams.StreamSequenceToken token) { throw null; }

        public int GetMaxAddCount() { throw null; }

        public Scynapse.Streams.StreamSequenceToken GetSequenceToken(ref Common.CachedMessage cachedMessage) { throw null; }
    ...
    public partial interface IStreamGenerator
    {
        ...
        bool TryReadEvents(System.DateTime utcNow, int maxCount, out System.Collections.Generic.List<Scynapse.Streams.IBatchContainer> events);
    }
...
{
    public partial interface IMessageDeliveryBackoffProvider : Scynapse.Internal.IBackoffProvider
    {
    }

    public partial interface IQueueReaderBackoffProvider : Scynapse.Internal.IBackoffProvider
    {
    }
}
...
namespace Scynapse.Streams
{
    ...
    [GenerateSerializer]
    public sealed partial class CacheFullException : Runtime.ScynapseException
    {
    ...
    [GenerateSerializer]
    public partial class DataNotAvailableException : Runtime.ScynapseException
    {
    ...
    [GenerateSerializer]
    public sealed partial class FaultedSubscriptionException : Runtime.ScynapseException
    {
    ...
    [GenerateSerializer]
    public sealed partial class ProviderStartException : Runtime.ScynapseException
    {
    ...
    [GenerateSerializer]
    public sealed partial class StreamEventDeliveryFailureException : Runtime.ScynapseException
    {
...
namespace ScynapseCodeGen.Scynapse.Hosting
{
    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_SimpleGeneratorOptions : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Hosting.SimpleGeneratorOptions>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Hosting.SimpleGeneratorOptions instance) { }

        public global::Scynapse.Hosting.SimpleGeneratorOptions ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Hosting.SimpleGeneratorOptions instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Hosting.SimpleGeneratorOptions value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_SimpleGeneratorOptions : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Hosting.SimpleGeneratorOptions>, global::Scynapse.Serialization.Cloning.IDeepCopier
    {
        public global::Scynapse.Hosting.SimpleGeneratorOptions DeepCopy(global::Scynapse.Hosting.SimpleGeneratorOptions original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }
}
...
namespace ScynapseCodeGen.Scynapse.Providers
{
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_DefaultMemoryMessageBodySerializer : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Providers.DefaultMemoryMessageBodySerializer>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_DefaultMemoryMessageBodySerializer(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Providers.DefaultMemoryMessageBodySerializer> _activator, global::Scynapse.Runtime.OnDeserializedCallbacks _hook0) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Providers.DefaultMemoryMessageBodySerializer instance) { }

        public global::Scynapse.Providers.DefaultMemoryMessageBodySerializer ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Providers.DefaultMemoryMessageBodySerializer instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Providers.DefaultMemoryMessageBodySerializer value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341 : global::Scynapse.Serialization.Codecs.IFieldCodec<Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341 instance) { }

        public Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341 ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341 instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341 value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A : global::Scynapse.Serialization.Codecs.IFieldCodec<Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A instance) { }

        public Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_MemoryMessageBody : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Providers.MemoryMessageBody>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_MemoryMessageBody(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Providers.MemoryMessageBody> _activator, global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Providers.MemoryMessageBody instance) { }

        public global::Scynapse.Providers.MemoryMessageBody ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Providers.MemoryMessageBody instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Providers.MemoryMessageBody value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_MemoryMessageData : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Providers.MemoryMessageData>, global::Scynapse.Serialization.Codecs.IFieldCodec, global::Scynapse.Serialization.Serializers.IValueSerializer<global::Scynapse.Providers.MemoryMessageData>, global::Scynapse.Serialization.Serializers.IValueSerializer
    {
        public Codec_MemoryMessageData(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, scoped ref global::Scynapse.Providers.MemoryMessageData instance) { }

        public global::Scynapse.Providers.MemoryMessageData ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, scoped ref global::Scynapse.Providers.MemoryMessageData instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Providers.MemoryMessageData value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341 : global::Scynapse.Serialization.Cloning.IDeepCopier<Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341>, global::Scynapse.Serialization.Cloning.IDeepCopier
    {
        public Copier_Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341 DeepCopy(Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341 original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A : global::Scynapse.Serialization.Cloning.IDeepCopier<Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A>, global::Scynapse.Serialization.Cloning.IDeepCopier
    {
        public Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A DeepCopy(Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_MemoryMessageBody : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Providers.MemoryMessageBody>, global::Scynapse.Serialization.Cloning.IDeepCopier
    {
        public Copier_MemoryMessageBody(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Providers.MemoryMessageBody> _activator, global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public global::Scynapse.Providers.MemoryMessageBody DeepCopy(global::Scynapse.Providers.MemoryMessageBody original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_MemoryMessageData : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Providers.MemoryMessageData>, global::Scynapse.Serialization.Cloning.IDeepCopier
    {
        public Copier_MemoryMessageData(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public global::Scynapse.Providers.MemoryMessageData DeepCopy(global::Scynapse.Providers.MemoryMessageData result, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    [global::Scynapse.CompoundTypeAlias(new[] { "inv", typeof(global::Scynapse.Runtime.GrainReference), typeof(global::Scynapse.Providers.IMemoryStreamQueueGrain), "74D60341" })]
    public sealed partial class Invokable_IMemoryStreamQueueGrain_GrainReference_74D60341 : global::Scynapse.Runtime.TaskRequest
    {
        public global::Scynapse.Providers.MemoryMessageData arg0;
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    [global::Scynapse.CompoundTypeAlias(new[] { "inv", typeof(global::Scynapse.Runtime.GrainReference), typeof(global::Scynapse.Providers.IMemoryStreamQueueGrain), "7A8F8C1A" })]
    public sealed partial class Invokable_IMemoryStreamQueueGrain_GrainReference_7A8F8C1A : global::Scynapse.Runtime.TaskRequest<System.Collections.Generic.List<global::Scynapse.Providers.MemoryMessageData>>
    {
        public int arg0;
        public override void Dispose() { }
        ...
        protected override System.Threading.Tasks.Task<System.Collections.Generic.List<global::Scynapse.Providers.MemoryMessageData>> InvokeInner() { throw null; }
...
namespace ScynapseCodeGen.Scynapse.Providers.Streams.Common
{
    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_EventSequenceToken : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Providers.Streams.Common.EventSequenceToken>, global::Scynapse.Serialization.Codecs.IFieldCodec, global::Scynapse.Serialization.Serializers.IBaseCodec<global::Scynapse.Providers.Streams.Common.EventSequenceToken>, global::Scynapse.Serialization.Serializers.IBaseCodec
    {
        public Codec_EventSequenceToken(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Providers.Streams.Common.EventSequenceToken instance) { }

        public global::Scynapse.Providers.Streams.Common.EventSequenceToken ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Providers.Streams.Common.EventSequenceToken instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Providers.Streams.Common.EventSequenceToken value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_EventSequenceTokenV2 : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2>, global::Scynapse.Serialization.Codecs.IFieldCodec, global::Scynapse.Serialization.Serializers.IBaseCodec<global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2>, global::Scynapse.Serialization.Serializers.IBaseCodec
    {
        public Codec_EventSequenceTokenV2(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2 instance) { }

        public global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2 ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2 instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2 value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_EventSequenceToken : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Providers.Streams.Common.EventSequenceToken>, global::Scynapse.Serialization.Cloning.IDeepCopier, global::Scynapse.Serialization.Cloning.IBaseCopier<global::Scynapse.Providers.Streams.Common.EventSequenceToken>, global::Scynapse.Serialization.Cloning.IBaseCopier
    {
        public Copier_EventSequenceToken(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void DeepCopy(global::Scynapse.Providers.Streams.Common.EventSequenceToken input, global::Scynapse.Providers.Streams.Common.EventSequenceToken output, global::Scynapse.Serialization.Cloning.CopyContext context) { }

        public global::Scynapse.Providers.Streams.Common.EventSequenceToken DeepCopy(global::Scynapse.Providers.Streams.Common.EventSequenceToken original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_EventSequenceTokenV2 : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2>, global::Scynapse.Serialization.Cloning.IDeepCopier, global::Scynapse.Serialization.Cloning.IBaseCopier<global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2>, global::Scynapse.Serialization.Cloning.IBaseCopier
    {
        public Copier_EventSequenceTokenV2(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void DeepCopy(global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2 input, global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2 output, global::Scynapse.Serialization.Cloning.CopyContext context) { }

        public global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2 DeepCopy(global::Scynapse.Providers.Streams.Common.EventSequenceTokenV2 original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }
}

namespace ScynapseCodeGen.Scynapse.Providers.Streams.Generator
{
    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_GeneratedBatchContainer : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Providers.Streams.Generator.GeneratedBatchContainer>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_GeneratedBatchContainer(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Providers.Streams.Generator.GeneratedBatchContainer> _activator, global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Providers.Streams.Generator.GeneratedBatchContainer instance) { }

        public global::Scynapse.Providers.Streams.Generator.GeneratedBatchContainer ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Providers.Streams.Generator.GeneratedBatchContainer instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Providers.Streams.Generator.GeneratedBatchContainer value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_GeneratedEvent : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Providers.Streams.Generator.GeneratedEvent>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_GeneratedEvent(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Providers.Streams.Generator.GeneratedEvent instance) { }

        public global::Scynapse.Providers.Streams.Generator.GeneratedEvent ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Providers.Streams.Generator.GeneratedEvent instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Providers.Streams.Generator.GeneratedEvent value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_GeneratedBatchContainer : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Providers.Streams.Generator.GeneratedBatchContainer>, global::Scynapse.Serialization.Cloning.IDeepCopier
    {
        public Copier_GeneratedBatchContainer(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Providers.Streams.Generator.GeneratedBatchContainer> _activator, global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public global::Scynapse.Providers.Streams.Generator.GeneratedBatchContainer DeepCopy(global::Scynapse.Providers.Streams.Generator.GeneratedBatchContainer original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_GeneratedEvent : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Providers.Streams.Generator.GeneratedEvent>, global::Scynapse.Serialization.Cloning.IDeepCopier
    {
        public Copier_GeneratedEvent(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public global::Scynapse.Providers.Streams.Generator.GeneratedEvent DeepCopy(global::Scynapse.Providers.Streams.Generator.GeneratedEvent original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }
}
...
namespace ScynapseCodeGen.Scynapse.Runtime
{
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_QualifiedStreamId : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Runtime.QualifiedStreamId>, global::Scynapse.Serialization.Codecs.IFieldCodec, global::Scynapse.Serialization.Serializers.IValueSerializer<global::Scynapse.Runtime.QualifiedStreamId>, global::Scynapse.Serialization.Serializers.IValueSerializer
    {
        public Codec_QualifiedStreamId(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, scoped ref global::Scynapse.Runtime.QualifiedStreamId instance) { }

        public global::Scynapse.Runtime.QualifiedStreamId ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, scoped ref global::Scynapse.Runtime.QualifiedStreamId instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Runtime.QualifiedStreamId value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_StreamId : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Runtime.StreamId>, global::Scynapse.Serialization.Codecs.IFieldCodec, global::Scynapse.Serialization.Serializers.IValueSerializer<global::Scynapse.Runtime.StreamId>, global::Scynapse.Serialization.Serializers.IValueSerializer
    {
        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, scoped ref global::Scynapse.Runtime.StreamId instance) { }

        public global::Scynapse.Runtime.StreamId ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, scoped ref global::Scynapse.Runtime.StreamId instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Runtime.StreamId value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
}

namespace ScynapseCodeGen.Scynapse.Streams
{
    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_BatchContainerBatch : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.BatchContainerBatch>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_BatchContainerBatch(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Streams.BatchContainerBatch> _activator, global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Streams.BatchContainerBatch instance) { }

        public global::Scynapse.Streams.BatchContainerBatch ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Streams.BatchContainerBatch instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.BatchContainerBatch value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_CacheFullException : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.CacheFullException>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_CacheFullException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Streams.CacheFullException instance) { }

        public global::Scynapse.Streams.CacheFullException ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Streams.CacheFullException instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.CacheFullException value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_DataNotAvailableException : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.DataNotAvailableException>, global::Scynapse.Serialization.Codecs.IFieldCodec, global::Scynapse.Serialization.Serializers.IBaseCodec<global::Scynapse.Streams.DataNotAvailableException>, global::Scynapse.Serialization.Serializers.IBaseCodec
    {
        public Codec_DataNotAvailableException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Streams.DataNotAvailableException instance) { }

        public global::Scynapse.Streams.DataNotAvailableException ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Streams.DataNotAvailableException instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.DataNotAvailableException value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_FaultedSubscriptionException : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.FaultedSubscriptionException>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_FaultedSubscriptionException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Streams.FaultedSubscriptionException instance) { }

        public global::Scynapse.Streams.FaultedSubscriptionException ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Streams.FaultedSubscriptionException instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.FaultedSubscriptionException value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_ProviderStartException : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.ProviderStartException>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_ProviderStartException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Streams.ProviderStartException instance) { }

        public global::Scynapse.Streams.ProviderStartException ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Streams.ProviderStartException instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.ProviderStartException value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_PubSubSubscriptionState : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.PubSubSubscriptionState>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_PubSubSubscriptionState(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Streams.PubSubSubscriptionState> _activator, global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Streams.PubSubSubscriptionState instance) { }

        public global::Scynapse.Streams.PubSubSubscriptionState ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Streams.PubSubSubscriptionState instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.PubSubSubscriptionState value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_QueueCacheMissException : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.QueueCacheMissException>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_QueueCacheMissException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Streams.QueueCacheMissException instance) { }

        public global::Scynapse.Streams.QueueCacheMissException ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Streams.QueueCacheMissException instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.QueueCacheMissException value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_QueueId : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.QueueId>, global::Scynapse.Serialization.Codecs.IFieldCodec, global::Scynapse.Serialization.Serializers.IValueSerializer<global::Scynapse.Streams.QueueId>, global::Scynapse.Serialization.Serializers.IValueSerializer
    {
        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, scoped ref global::Scynapse.Streams.QueueId instance) { }

        public global::Scynapse.Streams.QueueId ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, scoped ref global::Scynapse.Streams.QueueId instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.QueueId value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_StreamEventDeliveryFailureException : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.StreamEventDeliveryFailureException>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_StreamEventDeliveryFailureException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Streams.StreamEventDeliveryFailureException instance) { }

        public global::Scynapse.Streams.StreamEventDeliveryFailureException ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Streams.StreamEventDeliveryFailureException instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.StreamEventDeliveryFailureException value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_StreamIdentity : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.StreamIdentity>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_StreamIdentity(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Streams.StreamIdentity> _activator) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Streams.StreamIdentity instance) { }

        public global::Scynapse.Streams.StreamIdentity ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Streams.StreamIdentity instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.StreamIdentity value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_StreamSequenceToken : global::Scynapse.Serialization.Serializers.AbstractTypeSerializer<global::Scynapse.Streams.StreamSequenceToken>
    {
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_StreamSubscriptionHandle<T> : global::Scynapse.Serialization.Serializers.AbstractTypeSerializer<global::Scynapse.Streams.StreamSubscriptionHandle<T>>
    {
    }
    ...
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_BatchContainerBatch : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Streams.BatchContainerBatch>, global::Scynapse.Serialization.Cloning.IDeepCopier
    {
        public Copier_BatchContainerBatch(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Streams.BatchContainerBatch> _activator, global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public global::Scynapse.Streams.BatchContainerBatch DeepCopy(global::Scynapse.Streams.BatchContainerBatch original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_CacheFullException : global::Scynapse.Serialization.GeneratedCodeHelpers.ScynapseGeneratedCodeHelper.ExceptionCopier<global::Scynapse.Streams.CacheFullException, global::Scynapse.Runtime.ScynapseException>
    {
        public Copier_CacheFullException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) : base(default(Serialization.Serializers.ICodecProvider)!) { }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_DataNotAvailableException : global::Scynapse.Serialization.GeneratedCodeHelpers.ScynapseGeneratedCodeHelper.ExceptionCopier<global::Scynapse.Streams.DataNotAvailableException, global::Scynapse.Runtime.ScynapseException>
    {
        public Copier_DataNotAvailableException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) : base(default(Serialization.Serializers.ICodecProvider)!) { }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_FaultedSubscriptionException : global::Scynapse.Serialization.GeneratedCodeHelpers.ScynapseGeneratedCodeHelper.ExceptionCopier<global::Scynapse.Streams.FaultedSubscriptionException, global::Scynapse.Runtime.ScynapseException>
    {
        public Copier_FaultedSubscriptionException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) : base(default(Serialization.Serializers.ICodecProvider)!) { }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_ProviderStartException : global::Scynapse.Serialization.GeneratedCodeHelpers.ScynapseGeneratedCodeHelper.ExceptionCopier<global::Scynapse.Streams.ProviderStartException, global::Scynapse.Runtime.ScynapseException>
    {
        public Copier_ProviderStartException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) : base(default(Serialization.Serializers.ICodecProvider)!) { }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_PubSubSubscriptionState : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Streams.PubSubSubscriptionState>, global::Scynapse.Serialization.Cloning.IDeepCopier
    {
        public Copier_PubSubSubscriptionState(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Streams.PubSubSubscriptionState> _activator) { }

        public global::Scynapse.Streams.PubSubSubscriptionState DeepCopy(global::Scynapse.Streams.PubSubSubscriptionState original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_QueueCacheMissException : global::Scynapse.Serialization.GeneratedCodeHelpers.ScynapseGeneratedCodeHelper.ExceptionCopier<global::Scynapse.Streams.QueueCacheMissException, global::Scynapse.Streams.DataNotAvailableException>
    {
        public Copier_QueueCacheMissException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) : base(default(Serialization.Serializers.ICodecProvider)!) { }

        public override void DeepCopy(global::Scynapse.Streams.QueueCacheMissException input, global::Scynapse.Streams.QueueCacheMissException output, global::Scynapse.Serialization.Cloning.CopyContext context) { }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_StreamEventDeliveryFailureException : global::Scynapse.Serialization.GeneratedCodeHelpers.ScynapseGeneratedCodeHelper.ExceptionCopier<global::Scynapse.Streams.StreamEventDeliveryFailureException, global::Scynapse.Runtime.ScynapseException>
    {
        public Copier_StreamEventDeliveryFailureException(global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) : base(default(Serialization.Serializers.ICodecProvider)!) { }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_StreamSequenceToken : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Streams.StreamSequenceToken>, global::Scynapse.Serialization.Cloning.IDeepCopier, global::Scynapse.Serialization.Cloning.IBaseCopier<global::Scynapse.Streams.StreamSequenceToken>, global::Scynapse.Serialization.Cloning.IBaseCopier
    {
        public global::Scynapse.Streams.StreamSequenceToken DeepCopy(global::Scynapse.Streams.StreamSequenceToken original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }

        public void DeepCopy(global::Scynapse.Streams.StreamSequenceToken input, global::Scynapse.Streams.StreamSequenceToken output, global::Scynapse.Serialization.Cloning.CopyContext context) { }
    }

    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Copier_StreamSubscriptionHandle<T> : global::Scynapse.Serialization.Cloning.IDeepCopier<global::Scynapse.Streams.StreamSubscriptionHandle<T>>, global::Scynapse.Serialization.Cloning.IDeepCopier, global::Scynapse.Serialization.Cloning.IBaseCopier<global::Scynapse.Streams.StreamSubscriptionHandle<T>>, global::Scynapse.Serialization.Cloning.IBaseCopier
    {
        public global::Scynapse.Streams.StreamSubscriptionHandle<T> DeepCopy(global::Scynapse.Streams.StreamSubscriptionHandle<T> original, global::Scynapse.Serialization.Cloning.CopyContext context) { throw null; }

        public void DeepCopy(global::Scynapse.Streams.StreamSubscriptionHandle<T> input, global::Scynapse.Streams.StreamSubscriptionHandle<T> output, global::Scynapse.Serialization.Cloning.CopyContext context) { }
    }
}

namespace ScynapseCodeGen.Scynapse.Streams.Core
{
    [System.CodeDom.Compiler.GeneratedCode("ScynapseCodeGen", "9.0.0.0")]
    [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
    [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
    public sealed partial class Codec_StreamSubscription : global::Scynapse.Serialization.Codecs.IFieldCodec<global::Scynapse.Streams.Core.StreamSubscription>, global::Scynapse.Serialization.Codecs.IFieldCodec
    {
        public Codec_StreamSubscription(global::Scynapse.Serialization.Activators.IActivator<global::Scynapse.Streams.Core.StreamSubscription> _activator, global::Scynapse.Serialization.Serializers.ICodecProvider codecProvider) { }

        public void Deserialize<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Streams.Core.StreamSubscription instance) { }

        public global::Scynapse.Streams.Core.StreamSubscription ReadValue<TReaderInput>(ref global::Scynapse.Serialization.Buffers.Reader<TReaderInput> reader, global::Scynapse.Serialization.WireProtocol.Field field) { throw null; }

        public void Serialize<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, global::Scynapse.Streams.Core.StreamSubscription instance)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }

        public void WriteField<TBufferWriter>(ref global::Scynapse.Serialization.Buffers.Writer<TBufferWriter> writer, uint fieldIdDelta, System.Type expectedType, global::Scynapse.Streams.Core.StreamSubscription value)
            where TBufferWriter : System.Buffers.IBufferWriter<byte> { }
    }
}