...
namespace Microsoft.Extensions.Hosting
{
    ...
    {
        public static Scynapse.Hosting.IClientBuilder UseRedisClustering(this Scynapse.Hosting.IClientBuilder builder, System.Action<Scynapse.Clustering.Redis.RedisClusteringOptions> configuration) { throw null; }

        public static Scynapse.Hosting.IClientBuilder UseRedisClustering(this Scynapse.Hosting.IClientBuilder builder, string redisConnectionString) { throw null; }
    }

    public static partial class RedisClusteringISiloBuilderExtensions
    {
        public static Scynapse.Hosting.ISiloBuilder UseRedisClustering(this Scynapse.Hosting.ISiloBuilder builder, System.Action<Scynapse.Clustering.Redis.RedisClusteringOptions> configuration) { throw null; }

        public static Scynapse.Hosting.ISiloBuilder UseRedisClustering(this Scynapse.Hosting.ISiloBuilder builder, string redisConnectionString) { throw null; }
    }
}
