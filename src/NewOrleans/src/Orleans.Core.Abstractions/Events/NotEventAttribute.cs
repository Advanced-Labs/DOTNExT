...
namespace Orleans
{
    ...
    /// <c>IGrainWithXXXKey</c> interfaces are processed by the NewOrleans Events
    ...
    /// <item><description>NOT be connected to Orleans Streams</description></item>
    ...
    /// {
    ///     // This event will be distributed via Orleans Streams
