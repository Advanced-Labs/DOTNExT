...
/// <summary>
/// Scenario 9: NewOrleans Events
///
/// Tests the NewOrleans Events v1 feature which enables standard C# events
...
public static class EventScenario
{
    ...
    public static async Task RunAsync()
    {
        ...
        AnsiConsole.MarkupLine("[blue]  Scenario 9: NewOrleans Events[/]");
        AnsiConsole.MarkupLine("[blue]═══════════════════════════════════════════════════════[/]");
    ...
    {
        AnsiConsole.MarkupLine("[bold]NewOrleans Events v1 Feature[/]");
        AnsiConsole.WriteLine();
